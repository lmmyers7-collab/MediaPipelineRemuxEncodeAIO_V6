(function () {
  ...
  const telemetryGpuProjectionModule = window.__telemetryGpuProjectionModule || {};
  delete window.__telemetryGpuProjectionModule;
  ...
  const telemetryGpuProjection = typeof telemetryGpuProjectionModule.createTelemetryGpuProjectionModule === "function"
    ? telemetryGpuProjectionModule.createTelemetryGpuProjectionModule({ telemetryHasNumber, telemetryPercentNumber })
    : {};
  const {
    telemetryGpuPresent,
