(function () {
  const createQueueRerunApiModule = window.__queueRerunApiModule?.createQueueRerunApiModule;
  delete window.__queueRerunApiModule;
  ...
  function createQueueRerunModule(deps = {}) {
    ...
    const queueRerunApi = typeof createQueueRerunApiModule === "function"
      ? createQueueRerunApiModule({ apiGet, apiPost })
      : {};
    const {
      RERUN_PREVIEW_ROUTE,
