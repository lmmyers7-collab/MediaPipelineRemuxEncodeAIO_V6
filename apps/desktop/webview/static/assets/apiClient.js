(function () {
  ...
  const ROUTE_ACTIONS = [
    ...
    { method: "POST", pattern: /^\/api\/rerun\/control$/, action: "send rerun control" },
    { method: "POST", pattern: /^\/api\/rerun\/continue$/, action: "continue rerun" },
    { method: "POST", pattern: /^\/api\/rerun\/preview$/, action: "preview rerun" },
