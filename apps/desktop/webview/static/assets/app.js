...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (renamePreviewButton && !renameUsesStandaloneWorkbench) renamePreviewButton.addEventListener("click", refreshRenamePreview);
  ...
  if (renameBrowseFilesButton && !renameUsesStandaloneWorkbench) renameBrowseFilesButton.addEventListener("click", () => window.mediaPipelineRenameView?.browseRenamePaths?.("files"));
  const renameBrowseFolderButton = byId("rename-browse-folder-button");
  if (renameBrowseFolderButton && !renameUsesStandaloneWorkbench) renameBrowseFolderButton.addEventListener("click", () => window.mediaPipelineRenameView?.browseRenamePaths?.("folder"));
  ...
  if (renameClearPathsButton && !renameUsesStandaloneWorkbench) renameClearPathsButton.addEventListener("click", () => window.mediaPipelineRenameView?.clearRenamePaths?.());
  ...
  if (renameApplySelectedButton && !renameUsesStandaloneWorkbench) renameApplySelectedButton.addEventListener("click", () => window.mediaPipelineRenameView?.applySelectedRename?.());
