"""Compatibility shim. Moved to ``mediapipeline.core.kernel.dto_workspaces`` by ADR-0013 (Wave 3).
...
# Literal __all__ mirrors mediapipeline.core.kernel.dto_workspaces (application public-API
