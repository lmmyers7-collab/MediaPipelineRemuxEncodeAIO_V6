...
def _bundled_pwsh_candidates() -> list[str]:
    ...
    The repo ships `ops/pipeline/runtime/PowerShell-7.6.0-win-x64/pwsh.exe`. That binary
    ...
    for pattern in (
        ...
        "ops/pipeline/runtime/PowerShell-*/pwsh.exe",
    ):
...
def _windows_powershell_candidates() -> list[str]:
    ...
    dialog. The bundled `ops/pipeline/runtime/PowerShell-7.6.0-win-x64/pwsh.exe` is
