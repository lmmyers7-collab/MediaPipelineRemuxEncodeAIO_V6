...
GET_ROUTE_HANDLERS: dict[str, RouteHandlerSpec] = {
    ...
    "/api/failures/artifacts": RouteHandlerSpec("_failure_artifacts_payload"),
    ...
    "/api/audit-sources": RouteHandlerSpec("_audit_sources_payload"),
    "/api/rerun/results": RouteHandlerSpec("_rerun_results_payload", needs_query=True),
    ...
    "/api/libraries/summary": RouteHandlerSpec("_libraries_summary_payload"),
