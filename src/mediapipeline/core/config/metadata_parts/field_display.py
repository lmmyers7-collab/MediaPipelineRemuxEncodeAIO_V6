...
_PHASE3_DISPLAY_METADATA_BY_KEY: dict[str, dict[str, object]] = {
    ...
    "MovieRoute1080pTargetSizeGB": {
        ...
        "strictness": "soft",
        "library_profile_designations": ("movie", "auto"),
        "help_text": "GB target output size for known-height movie sources in the 1080p bucket. Unknown-height movies use Movie target output size.",
    },
    ...
    "TVRoute1080pTargetSizeGB": {
        ...
        "strictness": "soft",
        "library_profile_designations": ("tv", "auto"),
        "help_text": "GB target output size for known-height TV sources in the 1080p bucket. Unknown-height TV uses TV target output size.",
    },
    ...
    "MovieRouteMaxVideoBitrateMbps": {
        ...
        "strictness": "hard",
        "library_profile_designations": ("movie", "auto"),
        "help_text": "Fallback movie bitrate cap in Mbps when source height is unknown. Known-height sources use the 1080p, 1440p, or 4K bucket cap instead.",
    },
    "TVRouteMaxVideoBitrateMbps": {
        ...
        "strictness": "hard",
        "library_profile_designations": ("tv", "auto"),
        "help_text": "Fallback TV bitrate cap in Mbps when source height is unknown. Known-height sources use the 1080p, 1440p, or 4K bucket cap instead.",
    },
    "Route1080pBucketMaxHeight": {
        "label": "Legacy 1080p bucket max height",
        "short_label": "Raw 1080p Height",
        "section": "Size / Bitrate Guards",
        "rule_taxonomy": ("size", "bitrate", "routing"),
        "strictness": "hard",
        "help_text": "Compatibility pixel height derived from height tolerance settings when those percent keys are present.",
    },
    ...
    "Route4KBucketMinHeight": {
        "label": "Legacy 4K bucket min height",
        "short_label": "Raw 4K Height",
        "section": "Size / Bitrate Guards",
        "rule_taxonomy": ("size", "bitrate", "routing"),
        "strictness": "hard",
        "help_text": "Compatibility pixel height derived from height tolerance settings when those percent keys are present.",
