...
from mediapipeline.core.diagnostics.open_policy import (
...
from mediapipeline.core.diagnostics.policy import (
...
from mediapipeline.core.diagnostics.state_summary import (
...
class DiagnosticsFacadeMixin:
    ...
    def get_diagnostics(self, snapshot: Snapshot) -> DiagnosticsDto:
        ...
        return DiagnosticsDto(
            ...
            eta=eta_payload(worker_progress, progress=snapshot.progress or {}),
