...
from mediapipeline.contracts.stages import ProbeResult
from mediapipeline.core.orchestration.runner import RunnerOptions, run_probe_stage as _default_run_probe_stage
...
def _run_probe_stage_compat(payload: dict[str, Any], options: RunnerOptions):
    legacy_module = sys.modules.get("mediapipeline.core.api.commands_file_overrides")
