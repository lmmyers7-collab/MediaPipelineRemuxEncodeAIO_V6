...
COMMAND_ROUTE_METHODS: dict[str, str] = {
    ...
    "/api/queue/file-overrides/series-clear-preview": "_file_overrides_series_clear_preview_payload",
    "/api/queue/file-overrides/series-clear-apply": "_file_overrides_series_clear_apply_payload",
    ...
    "/api/failures/archive-evidence": "_failures_archive_evidence_payload",
    "/api/failures/open": "_failures_open_payload",
    "/api/failures/artifacts/cleanup": "_failures_artifacts_cleanup_payload",
    "/api/failures/lifecycle": "_failures_lifecycle_payload",
    ...
    "/api/path-picker/browse": "_path_picker_browse_payload",
    ...
    "/api/audit/stop": "_audit_stop_payload",
    "/api/audit/sources": "_audit_sources_command_payload",
    "/api/audit/sources/scan": "_audit_sources_scan_payload",
    ...
    "/api/rerun/preview": "_rerun_preview_payload",
    "/api/rerun/network-preview": "_rerun_network_preview_payload",
    "/api/rerun/network/start-dry-run": "_rerun_network_start_dry_run_payload",
    "/api/rerun/network/start": "_rerun_network_start_payload",
    "/api/rerun/network/retry": "_rerun_network_retry_payload",
    "/api/rerun/start": "_rerun_start_payload",
    "/api/rerun/control": "_rerun_control_payload",
    "/api/rerun/continue": "_rerun_continue_payload",
    "/api/rerun/open": "_rerun_open_payload",
    "/api/rerun/promote-dry-run": "_rerun_promote_dry_run_payload",
    "/api/rerun/promote": "_rerun_promote_payload",
    "/api/backend/lifecycle/reconcile-dry-run": "_backend_lifecycle_reconcile_dry_run_payload",
    "/api/backend/lifecycle/reconcile": "_backend_lifecycle_reconcile_payload",
