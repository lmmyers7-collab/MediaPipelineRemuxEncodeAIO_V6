...
from mediapipeline.core.status.errors import format_recent_error_summary
...
from mediapipeline.core.status.summary import build_status_summary as build_status_summary_text
...
class StatusServiceMixin:
    ...
    def _build_current_work(
        ...
        movie_cleaning_policy = rename_cleaning_policy_from_resolved(resolved) if resolved is not None else None
        return build_current_work(progress, movie_cleaning_policy=movie_cleaning_policy)
