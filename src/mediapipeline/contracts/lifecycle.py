...
LIFECYCLE_STATES: tuple[LifecycleState, ...] = (
    ...
    LifecycleState(
        ...
        description="No canonical incoming/ intake_pending folder state exists in the current runtime today.",
    ...
    LifecycleState(
        ...
        description="The audit terms exist as desired lifecycle concepts but are not canonical current runtime folders today.",
