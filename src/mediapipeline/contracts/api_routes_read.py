...
LOCAL_API_INVENTORY_READ_ROUTE_CONTRACT: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "purpose": "Read backend-derived CSV rerun manifests, review outputs, and import/scoped CSV candidates without accepting arbitrary paths, publishing, moving, deleting, or touching media files.",
    },
    {
        "method": "GET",
