...
Run these from the V5 workspace root as appropriate. These commands are validation gates only; they do not replace the real-media sample run evidence above.
