...
# ==============================================================================
# ffprobe-driven media inspection helpers used by engine/probe/stage.ps1 and
...
#   Invoke-NativeCommand      — engine\shared\native.ps1
#   Start-StopAwareSleep      — engine\shared\native.ps1
#   Get-FFprobeFailureCode    — engine\shared\failure_codes.ps1
