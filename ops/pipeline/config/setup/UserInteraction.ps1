...
function Show-Closing {
    ...
    Write-Host '  2. If dependencies are installed, run ops\scripts\dev\run.bat from the repository root.'
    Write-Host '  3. Re-run ops\scripts\dev\setup.bat any time to edit or validate the config.'
}
