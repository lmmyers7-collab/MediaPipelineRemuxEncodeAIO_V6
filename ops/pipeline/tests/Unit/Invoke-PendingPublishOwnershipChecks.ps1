...
$requiredModuleFiles = [ordered]@{
    'publish_completion.ps1'      = 'ops\pipeline\engine\publish\publish_completion.ps1'
    'publish_partial.ps1'         = 'ops\pipeline\engine\publish\publish_partial.ps1'
    'publish_sidecars.ps1'        = 'ops\pipeline\engine\publish\publish_sidecars.ps1'
    'pending_manifest_store.ps1'  = 'ops\pipeline\engine\publish\pending_manifest_store.ps1'
    'pending_transactions.ps1'    = 'ops\pipeline\engine\publish\pending_transactions.ps1'
    'pending_push.ps1'            = 'ops\pipeline\engine\publish\pending_push.ps1'
    'pending_publish_index.ps1'   = 'ops\pipeline\engine\publish\pending_publish_index.ps1'
}
