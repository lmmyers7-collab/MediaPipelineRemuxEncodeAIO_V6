...
Assert-Equal $toolErrorRecord['outcome'] 'error' 'Tool errors should stay fail-open as error outcome.'
Assert-True (-not [bool]$toolErrorRecord['block_publish']) 'Tool errors must not block publish.'
