...
function Get-MediaPipelineKnownOutcomeCodes {
    ...
    foreach ($code in @(
        ...
        'DYNAMIC_HDR_OUTPUT_METADATA_MISSING',
        'DYNAMIC_HDR_OUTPUT_VERIFY_FAILED',
        'DYNAMIC_HDR_OUTPUT_VERIFY_UNKNOWN',
        'DYNAMIC_HDR_PLAN_MISSING',
        'DYNAMIC_HDR_PRESERVATION_NOT_READY',
        ...
        'SUBTITLE_BURN_MULTI_VIDEO_UNSUPPORTED',
