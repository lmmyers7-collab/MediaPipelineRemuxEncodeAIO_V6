...
function Get-MediaPipelineConfigOrderedKeys {
    return @(
        ...
        'DeferredPublish','PendingPublishDrainMode','PendingPublishDrainBatchSize',
        ...
        'SubKeepLanguages','AllowSubtitleHelperFallback','ConvertTx3gToSrt','DropTx3gAfterConversion','CreateExternalTx3gSrtSidecars',
        ...
        'EnableWatchFolders','WatchFolderRoots','WatchDebounceSeconds','WatchScanTimeoutSeconds','WatchAction','WatchRespectScheduleWindow',
        'SkipStabilityCheck',
        'EnableIntegrityCheck','CreateTVSubfolder','AggressiveEpisodeParsing',
        'RobocopyFlags',
        'DebugMode','LogRetentionDays','InterruptedToolLogRetentionDays','PipelineDebugLogMaxBytes','FailureArtifactWarningThresholdGB','FailureArtifactRetentionDays','FailureArtifactCleanupTargetGB','PriorityMarkers','MixPriorityPhase','QueueOrderingStrategy','ConsoleLogLevel','FileLogLevel',
        ...
        'FFmpegEncodeTimeoutSeconds','FFmpegCpuEncodeTimeoutSeconds','CpuEncodeMutexWaitSeconds','FFmpegRemuxTimeoutSeconds','MkvmergeRemuxTimeoutSeconds','SubtitleExtractTimeoutSeconds','SubtitleProbeTimeoutSeconds','BdpgsOcrTimeoutSeconds','VobSubOcrTimeoutSeconds',
