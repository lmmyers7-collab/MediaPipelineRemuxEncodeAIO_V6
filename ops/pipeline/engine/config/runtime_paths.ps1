...
function Get-MediaPipelineResolvedConfigDump {
    ...
    $names = @(
        ...
        'MinFreeSpaceGB',
        'VideoCodec','VideoPreset','VideoQuality','OutputContainer','RemuxSafeVideoCodecs',
        'RenameMovieFilterOptions','RenameMovieFilterTerms','RenameMovieRemoveTerms','SubKeepLanguages',
