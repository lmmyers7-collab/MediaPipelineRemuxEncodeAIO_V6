...
function Test-MediaPipelineConfigEncodeAudioPolicy {
    ...
    foreach ($optionPolicy in @(
        ...
        @{ Key = 'PendingPublishDrainMode'; Label = 'PendingPublishDrainMode'; Allowed = @(Get-MediaPipelinePendingPublishDrainModeNames) },
    ...
    foreach ($numericPolicy in @(
        ...
        @{ Kind = 'int'; Key = 'CpuEncodeMutexWaitSeconds'; Label = 'CpuEncodeMutexWaitSeconds'; Min = 0; Max = 86400 },
        ...
        @{ Kind = 'int'; Key = 'ConsecutiveRoundFailureBlockLimit'; Label = 'ConsecutiveRoundFailureBlockLimit'; Min = 1; Max = 1000 },
        ...
        @{ Kind = 'int'; Key = 'PipelineDebugLogMaxBytes'; Label = 'PipelineDebugLogMaxBytes'; Min = 1048576; Max = 2147483647 },
        ...
        @{ Kind = 'int'; Key = 'WatchScanTimeoutSeconds'; Label = 'WatchScanTimeoutSeconds'; Min = 1; Max = 86400 },
