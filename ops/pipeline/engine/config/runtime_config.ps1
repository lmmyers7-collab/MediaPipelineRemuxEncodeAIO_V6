...
$script:ConvertBdpgsToSrt = Get-ConfigBool 'ConvertBdpgsToSrt' $true
...
$script:AutonomyPendingTotalReviewBytes = Get-ConfigInt64 'AutonomyPendingTotalReviewBytes' 107374182400 1048576 10995116277760
$script:AutonomyPendingTotalBlockBytes = Get-ConfigInt64 'AutonomyPendingTotalBlockBytes' 268435456000 1048576 10995116277760
