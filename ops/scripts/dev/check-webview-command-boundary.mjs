...
const confirmationRules = [
  ...
  { route: "/api/failures/artifacts/cleanup", confirmation: "confirm_delete", pattern: /confirm_delete\s*:\s*true/ },
...
const routeHintRules = [
  ...
  { pattern: /report-audit-scan-(selected|all)-button|scan selected|scan all/i, route: "/api/audit/sources/scan" },
  { pattern: /rerun-inspect-csv-button|inspect csv/i, route: "/api/rerun/preview" },
  { pattern: /rerun-open-csv-(?:button|folder-button)/i, route: "/api/rerun/open" },
  ...
  { pattern: /failure-artifact-cleanup-|delete artifacts|preview artifact cleanup/i, route: "/api/failures/artifacts/cleanup" },
