                ...
                json.dumps(
                    {
                        ...
                        "pid": None,
                        "app_pid": 1234,
                        "command_line": "pwsh -File MediaPipeline_chatgpt.ps1",
    ...
    def test_local_api_serves_read_only_web_prototype(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as raw_root:
            ...
            try:
                ...
                with urlopen(f"{server.url}/assets/commandHistory.js", timeout=5) as response:  # noqa: S310 - localhost test server
                    command_history_js = response.read().decode("utf-8")
                ...
                with urlopen(f"{server.url}/assets/renameView.js", timeout=5) as response:  # noqa: S310 - localhost test server
                    rename_view_js = response.read().decode("utf-8")
        ...
        self.assertIn('id="completed-size-review-status"', html)
        self.assertIn('id="completed-size-review-summary"', html)
        self.assertIn('id="completed-size-review-rows"', html)
        ...
        self.assertLess(html.index("/assets/formatters.js"), html.index("/assets/commandHistory.js"))
        ...
        self.assertIn("home-at-a-glance-summary", html)
        ...
        self.assertIn("completed-review-status", html)
        self.assertIn("completed-review-board", html)
        self.assertIn("completed-review-rows", html)
        self.assertIn("completed-review-legend", html)
        self.assertIn("completed-size-review-status", html)
        self.assertIn("completed-size-review-summary", html)
        self.assertIn("completed-size-review-rows", html)
        ...
        self.assertIn("rename-remove-terms", html)
        self.assertIn("Find Files / Preview", html)
        ...
        self.assertIn('data-movie-filter="video_source"', html)
        ...
        self.assertIn("Scope boundary: Completed filters, selected rows, proof boards", completed_view_evidence_js)
        ...
        self.assertIn("Completed display filter / backend action scope:", completed_view_evidence_js)
        self.assertIn("Backend action scope: unchanged.", completed_view_evidence_js)
        self.assertIn("Completed filters never accept outputs", completed_view_evidence_js)
        ...
        self.assertIn("Completed display filters cleared.", completed_view_js)
        ...
        self.assertIn("rename-use-editable-cleaning-filters", html)
        self.assertIn("rename-filter-video-source", html)
        self.assertIn("rename-filter-release-groups", html)
        self.assertIn("rename-cleaning-filters-save-button", html)
        self.assertIn("rename-cleaning-filters-reset-button", html)
        ...
        self.assertIn("Apply Status", html)
        ...
        self.assertIn("function scheduleCopyEditorDayToTargets", schedule_view_js)
        ...
        self.assertIn("data-schedule-copy-source", html)
        self.assertIn('data-schedule-copy-target="Tuesday"', html)
        self.assertIn("data-schedule-copy-apply", html)
        ...
        self.assertIn("${renderedCount} shown / ${rows.length} filtered / ${lastCompletedRows.length} rows", completed_view_js)
