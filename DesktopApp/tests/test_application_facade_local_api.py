...
class LocalApiServerTests(unittest.TestCase):
    ...
    def test_local_api_health_is_public_and_snapshot_requires_token(self) -> None:
        ...
        self.assertEqual(contract["network_lifecycle_summary"]["status"], "design_only_no_lifecycle_routes")
        self.assertFalse(contract["network_lifecycle_summary"]["mutation_enabled"])
        self.assertFalse(contract["network_lifecycle_summary"]["frontend_allowed"])
    ...
    def test_local_api_queue_state_routes_are_contracted_journaled_and_source_scoped(self) -> None:
        ...
        self.assertIn("outside configured SourceMovies/SourceTV roots", invalid_priority["errors"][0])
        ...
        self.assertIn("outside configured SourceMovies/SourceTV roots", override_invalid["errors"][0])
    ...
    def test_local_api_file_override_effective_read_reports_match_sources_and_library_defaults(self) -> None:
        ...
        self.assertIn("outside configured SourceMovies/SourceTV roots", invalid["message"])
    ...
    def test_local_api_file_override_route_preview_is_read_only_and_validates_proposals(self) -> None:
        ...
        self.assertIn("outside configured SourceMovies/SourceTV roots", "\n".join(invalid_path.get("errors", [])))
    ...
    def test_local_api_queue_and_rename_preview_contracts(self) -> None:
        ...
        self.assertTrue(rename_apply_payload["ok"])
    ...
    def test_local_api_serves_read_only_web_prototype(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as raw_root:
            ...
            try:
                ...
                with urlopen(f"{server.url}/assets/domHelpers.js", timeout=5) as response:  # noqa: S310 - localhost test server
                    dom_helpers_js = response.read().decode("utf-8")
                ...
                with urlopen(f"{server.url}/assets/completedView.evidence.js", timeout=5) as response:  # noqa: S310 - localhost test server
                    completed_view_evidence_js = response.read().decode("utf-8")
                ...
                with urlopen(f"{server.url}/assets/completedView.review.js", timeout=5) as response:  # noqa: S310 - localhost test server
                    completed_view_review_js = response.read().decode("utf-8")
                ...
                with urlopen(f"{server.url}/assets/launchView.risk.js", timeout=5) as response:  # noqa: S310 - localhost test server
                    launch_view_risk_js = response.read().decode("utf-8")
                ...
                with urlopen(f"{server.url}/assets/launchView.js", timeout=5) as response:  # noqa: S310 - localhost test server
                    launch_view_js = response.read().decode("utf-8")
        ...
        queue_view_js = "\n".join([queue_view_summary_js, queue_view_review_js, queue_view_detail_js, queue_view_launch_js, queue_view_parent_js])
        ...
        self.assertLess(html.index("/assets/apiClient.js"), html.index("/assets/domHelpers.js"))
        self.assertLess(html.index("/assets/domHelpers.js"), html.index("/assets/formatters.js"))
        self.assertLess(html.index("/assets/formatters.js"), html.index("/assets/commandHistory/formatters.js"))
        ...
        self.assertLess(html.index("/assets/diagnosticsBridge.js"), html.index("/assets/completedView.evidence.js"))
        self.assertLess(html.index("/assets/completedView.evidence.js"), html.index("/assets/completedView.proof.js"))
        self.assertLess(html.index("/assets/completedView.proof.js"), html.index("/assets/completedView.review.js"))
        ...
        self.assertLess(html.index("/assets/settingsMetadata.js"), html.index("/assets/settingsView.builders.audio.js"))
        ...
        self.assertLess(html.index("/assets/telemetryView.js"), html.index("/assets/progressView.js"))
        ...
        self.assertLess(html.index("/assets/launchHistoryView.js"), html.index("/assets/launchView.risk.js"))
        ...
        self.assertLess(html.index("/assets/launchView.preflight.js"), html.index("/assets/launchView.js"))
        ...
        self.assertIn("activity-original", html)
        ...
        self.assertIn("home-at-a-glance-status", html)
        self.assertIn("home-at-a-glance-current", html)
        self.assertIn("home-at-a-glance-detail", html)
        self.assertIn("home-at-a-glance-progress-bars", html)
        self.assertIn("home-at-a-glance-up-next", html)
        ...
        self.assertIn('data-reports-tab="overview"', html)
        ...
        self.assertIn("report-launch-handoff-status", html)
        self.assertIn("report-launch-handoff", html)
        self.assertIn("report-go-rerun-button", html)
        self.assertIn("report-go-audit-button", html)
        self.assertIn("report-go-diagnostics-button", html)
        self.assertIn("report-launch-handoff-action-status", html)
        ...
        self.assertIn("Worker Mode Settings", html)
        ...
        self.assertIn("Rename Filters", html)
        self.assertIn("rename-file-source-status", html)
        self.assertIn("rename-file-source-summary", html)
        self.assertIn("rename-add-path-input", html)
        self.assertIn("rename-browse-files-button", html)
        self.assertIn("rename-browse-folder-button", html)
        self.assertIn("rename-add-path-button", html)
        self.assertIn("rename-clear-paths-button", html)
        self.assertIn("rename-preview-top-button", html)
        self.assertIn("rename-use-selected-queue-button", html)
        self.assertIn("rename-use-loaded-queue-button", html)
        ...
        self.assertIn("rename-batch-safety", html)
        self.assertIn("rename-pipeline-handoff-status", html)
        self.assertIn("rename-pipeline-handoff", html)
        self.assertIn("rename-review-board-status", html)
        self.assertIn("rename-review-board", html)
        self.assertIn("rename-selection-audit-status", html)
        self.assertIn("rename-selection-audit", html)
        self.assertIn("rename-check-applicable-button", html)
        self.assertIn("rename-clear-checks-button", html)
        self.assertIn("rename-move-checked-up-button", html)
        self.assertIn("rename-move-checked-down-button", html)
        self.assertIn("rename-natural-sort-button", html)
        self.assertIn("rename-selected-count", html)
        self.assertIn("rename-bulk-edit-status", html)
        self.assertIn("rename-bulk-edit-summary", html)
        self.assertIn("rename-bulk-scope", html)
        self.assertIn("rename-bulk-stage-button", html)
        self.assertIn("rename-bulk-use-pipeline-button", html)
        self.assertIn("rename-bulk-force-button", html)
        self.assertIn("rename-bulk-clear-force-button", html)
        self.assertIn("rename-bulk-clear-button", html)
        self.assertIn("rename-selected-final", html)
        self.assertIn("rename-save-override-button", html)
        self.assertIn("rename-apply-selected-button", html)
        self.assertIn("rename-detail", html)
        ...
        self.assertNotIn("rename-selected-final", html[queue_start:completed_start])
        self.assertIn("rename-selected-final", html[rename_start:launch_start])
        self.assertIn("rename-apply-selected-button", html[rename_start:launch_start])
        self.assertIn("rename-detail", html[rename_start:launch_start])
        self.assertIn("rename-summary", html[rename_start:launch_start])
        self.assertIn("rename-batch-safety", html[rename_start:launch_start])
        self.assertIn("rename-pipeline-handoff", html[rename_start:launch_start])
        self.assertIn("rename-review-board", html[rename_start:launch_start])
        self.assertIn("rename-selection-audit", html[rename_start:launch_start])
        self.assertIn("rename-check-applicable-button", html[rename_start:launch_start])
        self.assertIn("rename-selected-count", html[rename_start:launch_start])
        self.assertIn("rename-natural-sort-button", html[rename_start:launch_start])
        self.assertIn("rename-bulk-edit-summary", html[rename_start:launch_start])
        self.assertIn("rename-bulk-stage-button", html[rename_start:launch_start])
        self.assertIn("rename-preview-top-button", html[rename_start:launch_start])
        self.assertIn("rename-add-path-input", html[rename_start:launch_start])
        self.assertIn("rename-add-path-button", html[rename_start:launch_start])
        self.assertIn("rename-clear-paths-button", html[rename_start:launch_start])
        self.assertIn("rename-use-selected-queue-button", html[rename_start:launch_start])
        self.assertIn("rename-use-loaded-queue-button", html[rename_start:launch_start])
        ...
        self.assertIn(".home-at-a-glance-panel {", css_pages)
        ...
        self.assertIn("raw.slice(0, 500)", api_client_js)
        ...
        self.assertIn("renderLaunchCommandHistory(commandHistory)", command_history_js)
        ...
        self.assertIn("renderSettingsCommandHistory(commandHistory)", command_history_js)
        ...
        self.assertIn("renderRenameApplyHistory(commandHistory)", command_history_js)
        self.assertIn("renderPipelineControlHistory(commandHistory)", command_history_js)
        self.assertIn("renderReportOpenHistory(commandHistory)", command_history_js)
        self.assertIn("renderNetworkOpenHistory(commandHistory)", command_history_js)
        self.assertIn("initNetworkViewEvents();", js)
        self.assertIn("function _storedOrderMatchesCurrentPanels", js)
        self.assertIn('page.dataset.layoutOrderStatus = "schema-reset"', js)
        self.assertIn("newly added panels appear at their authored default position", js)
        self.assertIn("function _showLayoutDragHint", js)
        self.assertIn("Still gated. Click Advanced to make this panel always visible.", js)
        ...
        self.assertIn("function renderCompletedRows", completed_view_js)
        ...
        self.assertIn("Completed output acceptance checklist:", completed_view_evidence_js)
        ...
        self.assertIn("acceptance requires display filter scope, output/sidecar proof, route/size explanation, pending-publish proof, and recent command evidence to agree.", completed_view_evidence_js)
        ...
        self.assertIn("Output Proof", html)
        ...
        self.assertIn("renderCompletedOutputAcceptance(lastCompletedPayload, lastCompletedRows", completed_view_js)
        self.assertIn("acceptance requires display filter scope, output/sidecar proof", completed_view_evidence_js)
        ...
        self.assertIn("completed-route-agreement-summary", html)
        self.assertIn("completed-route-agreement-detail", html)
        self.assertIn("function getLastCompletedPayload", completed_view_js)
        self.assertIn("completed-pending-proof-summary", html)
        self.assertIn("completed-pending-proof-detail", html)
        ...
        self.assertIn("function completedSelectedOpenTargetLines", completed_view_js)
        self.assertIn("Open boundary: Completed buttons send only row_key and target.", completed_view_js)
        ...
        self.assertIn("function resetCompletedFilters", completed_view_js)
        self.assertIn("Current Output Status filters cleared.", completed_view_js)
        self.assertIn("function resetCompletedHistoryFilters", completed_view_js)
        ...
        self.assertIn("function completedFreshnessLine", completed_view_js)
        self.assertIn("function completedManifestIsAged", completed_view_js)
        self.assertIn("Manifest age", completed_view_js)
        self.assertIn("History aged", completed_view_review_js)
        self.assertIn("Operator status:", completed_view_js)
        ...
        self.assertIn("Backend trust state:", completed_view_js)
        self.assertIn("Backend proof summary:", completed_view_js)
        self.assertIn("operator_trust_state", completed_view_js)
        self.assertIn("safe_next_action", completed_view_js)
        self.assertIn("unsafe_if_ignored", completed_view_js)
        self.assertIn("recommended_diagnostics_targets", completed_view_js)
        self.assertIn("Review flags:", completed_view_js)
        self.assertIn("Route decision:", completed_view_js)
        self.assertIn("Route evidence:", completed_view_js)
        self.assertIn("route_evidence_lines", completed_view_js)
        self.assertIn("operator_guidance", completed_view_js)
        ...
        self.assertIn("Completed Manifest", completed_view_js)
        ...
        self.assertIn("Output growth:", completed_view_js)
        ...
        self.assertIn("function requestCompletedOpen", completed_view_js)
        self.assertIn("/api/completed/open", completed_view_js)
        self.assertIn("[data-open-completed]", completed_view_js)
        self.assertIn("let completedOpenInFlight = false", completed_view_js)
        self.assertIn("function setCompletedOpenBusy", completed_view_js)
        self.assertIn("function rejectCompletedOpenWhileBusy", completed_view_js)
        self.assertIn("function renderCompletedOpenHistory", completed_view_js)
        self.assertIn("function isCompletedOpenCommand", completed_view_js)
        self.assertIn("Backend manifest row keys and target allowlists remain the source of truth.", completed_view_js)
        self.assertIn("function completedEmptyStateMessage", completed_view_js)
        self.assertIn("No completed history rows.", completed_view_js)
        ...
        self.assertIn("audio_decision_preview", completed_view_js)
        self.assertIn("subtitle_decision_preview", completed_view_js)
        ...
        self.assertIn("Runtime error code:", completed_view_js)
        self.assertIn("Runtime match:", completed_view_js)
        self.assertIn("Route reason:", completed_view_js)
        self.assertIn("Another completed open command is already in progress.", completed_view_js)
        self.assertIn("button.disabled = completedOpenInFlight", completed_view_js)
        ...
        self.assertIn("renderProgressBarsInto(\"queue-progress-bars\"", queue_view_js)
        ...
        self.assertIn("Excluded Files", html)
        ...
        self.assertIn("Backend launch scope preview:", queue_view_js)
        ...
        self.assertIn("launchBackendPreflightPayloadForTarget(\"pipeline\")", queue_view_js)
        self.assertIn("getLastLaunchBackendPreflightRefreshInfo()", queue_view_js)
        ...
        self.assertIn("Queue launch decision checklist:", queue_view_js)
        ...
        self.assertIn("launch only after backend launch preflight, queue payload, display filter scope, freshness, blocked rows, runtime context, completed exclusions, selected-row proof, command history, and Launch readiness agree.", queue_view_js)
        self.assertIn("Mutation guardrail: this checklist cannot launch, reorder, drop, rewrite queue snapshots, delete files, clear completed state, override schedule, or bypass backend validation.", queue_view_js)
        self.assertIn("queue-launch-decision-summary", html)
        self.assertIn("queue-launch-decision-detail", html)
        ...
        self.assertIn("Refresh Queue reloads backend snapshots only.", html)
        ...
        self.assertIn("function getLastQueuePayload", queue_view_js)
        self.assertIn("function getLastQueueRows", queue_view_js)
        ...
        self.assertIn("Mutation guardrail: queue mutation and processing start remain backend-owned commands", queue_view_js)
        ...
        self.assertIn("What remains unproven: final publish completion until Publish Parked Outputs succeeds", pending_publish_view_js)
        ...
        self.assertIn("Safe next action: row looks ready, but use only the backend-owned Publish Parked Outputs command to move files.", pending_publish_view_js)
        ...
        self.assertIn("This is the final read-only operator handoff before Publish Parked Outputs.", pending_publish_confidence_js)
        self.assertIn("Backend Publish Parked Outputs remains the only authority that can validate and move parked files.", pending_publish_confidence_js)
        ...
        self.assertIn("Publish Parked Outputs does not drain only the visible table subset.", pending_publish_confidence_js)
        ...
        self.assertIn("Selecting a row cannot make Publish Parked Outputs drain only that row.", pending_publish_drain_js)
        ...
        self.assertIn("Daily-use handoff: Pending Publish evidence decides whether it is sensible to press Publish Parked Outputs", pending_publish_confidence_js)
        ...
        self.assertIn("Publish Parked Outputs blocked by WebView evidence", pending_publish_confidence_js)
        ...
        self.assertIn("renderRenameApplyResult(entries[0] || null)", rename_history_view_js)
        ...
        self.assertIn("movie_filter_terms_enabled", rename_view_js)
        ...
        self.assertIn("settings-rename-use-editable-cleaning-filters", html)
        ...
        self.assertIn("Apply Reviewed Renames", html)
        ...
        self.assertIn("Outcome Review", html)
        ...
        self.assertIn("checked rows are sent as selected_sources", rename_view_js)
        ...
        self.assertIn("const visibleResult = { ...result, request }", rename_view_js)
        ...
        self.assertIn("Wait for the active rename preview to finish", rename_view_js)
        self.assertIn("Another rename apply command is already in progress.", rename_view_js)
        ...
        self.assertIn("Launch commands remain backend-owned", queue_view_js)
        ...
        self.assertIn("Publish Parked Outputs remains backend-owned", pending_publish_view_js)
        ...
        self.assertIn("settings_policy_impact.v1", settings_view_js)
        ...
        self.assertIn("renderSettingsLaunchImpactHandoffFromEntries(impactEntries)", settings_view_js)
        ...
        self.assertIn("function settingsBackendResultRows", settings_view_js)
        self.assertIn("function settingsBackendResultRowKey", settings_view_js)
        self.assertIn("function settingsBackendResultDetailLines", settings_view_js)
        self.assertIn("function renderSettingsBackendResultFromEntries", settings_view_js)
        self.assertIn("settings-backend-result-rows", settings_view_js)
        self.assertIn("settings-backend-result-detail", settings_view_js)
        ...
        self.assertIn("The backend save command requires confirm_save=true", settings_view_js)
        self.assertIn("Launch uses saved backend settings only", settings_view_js)
        ...
        self.assertIn("Per-worker overrides are configured.", settings_metadata_js)
        ...
        self.assertIn("Auth-token guardrail", settings_view_network_builder_js)
        self.assertIn("Start/stop coordinator and worker runtime remains backend-owned", settings_view_network_builder_js)
        ...
        self.assertIn("Publish Parked Outputs", settings_view_pending_builder_js)
        ...
        self.assertIn("window.renderSettingsCommandHistory = renderSettingsCommandHistory", settings_view_js)
        ...
        self.assertIn("Decision rule: WebView Network can be trusted for read-only evidence only", network_view_js)
        self.assertIn("Required before future lifecycle controls", network_view_js)
        ...
        self.assertIn("This checklist cannot start, stop, abort, reclaim, release", network_view_js)
        ...
        self.assertIn("button.dataset.openDiagnostics = artifact.target", diagnostics_view_js)
        self.assertIn("requestDiagnosticsOpen(artifact.target)", diagnostics_view_js)
        self.assertIn("tailButton.dataset.readDiagnosticsTail = artifact.tailTarget", diagnostics_view_js)
        self.assertIn("requestDiagnosticsTail(artifact.tailTarget)", diagnostics_view_js)
        ...
        self.assertIn("function renderReportLaunchHandoff", reports_view_js)
        self.assertIn("function reportLaunchHandoffLines", reports_view_js)
        self.assertIn("function reportGoToCsvRerun", reports_view_js)
        self.assertIn("function reportGoToAuditLaunch", reports_view_js)
        self.assertIn("function reportGoToDiagnostics", reports_view_js)
        self.assertIn("function initReportsViewEvents", reports_view_js)
        self.assertIn("Reports to Launch handoff:", reports_view_js)
        self.assertIn("Paste the verified CSV path manually", reports_view_js)
        self.assertIn("It never fills CSV Path, starts CSV Rerun, runs Audit", reports_view_js)
        self.assertIn("activateLaunchTab", reports_view_js)
        self.assertIn("renderLaunchAuditProgress(lastReportSnapshot)", reports_view_js)
        ...
        self.assertIn("Select a row to inspect classification", reports_view_js)
        ...
        self.assertIn("Switch on Use failure markers first", reports_view_js)
        self.assertIn("Select one or more failure marker rows first.", reports_view_js)
        self.assertIn("It does not touch media files or failure reports", reports_view_js)
        ...
        self.assertIn("requestDiagnosticsOpen(target)", reports_view_js)
        ...
        self.assertIn("Reports remains read-only; CSV rerun/export decisions must stay backend-owned.", reports_view_js)
        ...
        self.assertNotIn("NVENC idle", telemetry_view_js)
        ...
        self.assertIn("launchBackendPreflightPayloadForTarget(target)", launch_history_view_js)
        ...
        self.assertIn("Checklist correlation:", launch_view_js)
        ...
        self.assertIn("Correlation is explanatory only; backend start routes remain authoritative at submission time.", launch_view_js)
        ...
        self.assertIn("Saved settings preflight:", launch_view_risk_js)
        self.assertIn("Launch settings decision:", launch_view_risk_js)
        ...
        self.assertIn("Start guidance:", launch_view_risk_js)
        self.assertIn("Preflight owner: Settings page edits/preview/save; Launch page displays saved posture only.", launch_view_risk_js)
        ...
        self.assertIn("Implement backend dry-run lifecycle checks and command journaling before adding Network lifecycle routes", contract_view_js)
        ...
        self.assertIn('apiGet("/api/health")', js)
        ...
        self.assertIn("renderPipelineEvents(recentEvents)", js)
        self.assertIn("renderTelemetrySafely(values.telemetry)", js)
        ...
        self.assertIn('byId("completed-history-status-filter")', completed_view_js)
        self.assertIn('byId("completed-history-investigation-filter")', completed_view_js)
        self.assertIn("filterResultSummaryLines({", completed_view_js)
        self.assertIn("filterRowsByInvestigation(statusRows, investigationFilter, completedMatchesInvestigationFilter)", completed_view_js)
        self.assertIn("${renderedRows} shown / ${visibleRows} filtered / ${totalRows} rows", completed_view_js)
        self.assertIn("filtering Current Output Status does not mark outputs accepted", completed_view_js)
        self.assertIn("filtering Completed history does not mark outputs accepted", completed_view_js)
        self.assertIn("Completed review rows", completed_view_review_js)
        self.assertIn("selectCompletedRow(item)", completed_view_js)
        ...
        self.assertIn("function topbarOriginalCurrentName", js)
        ...
        self.assertIn("function renderHomeAtAGlance", js)
        self.assertIn("function homeAtAGlanceModel", js)
        self.assertIn("function homeAtAGlancePerFilePushBar", js)
        self.assertIn("function homeAtAGlanceProgressBar", js)
        self.assertIn("function renderHomeAtAGlanceQueue", js)
        self.assertIn("Push file", js)
        self.assertIn("home-at-a-glance-progress-bars", js)
        self.assertIn("Now processing", html)
        self.assertIn("Up next", html)
        self.assertIn("renderHomeAtAGlance(dashboardContext)", js)
        ...
        self.assertIn("renderRefreshInProgress()", js)
        self.assertIn("lastRefreshDurationMs", js)
        self.assertIn(".activity-original", css_layout)
        ...
        self.assertIn("renderHomeActiveWork({", js)
