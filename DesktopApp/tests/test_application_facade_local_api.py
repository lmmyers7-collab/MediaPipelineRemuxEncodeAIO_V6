...
class LocalApiServerTests(unittest.TestCase):
    ...
    def test_rename_clean_filename_preview_get_route_uses_backend_cleaner_without_command_journal(self) -> None:
        ...
        self.assertEqual(payload["movie_filter_terms_mode"], "always_on")
    ...
    def test_local_api_serves_read_only_web_prototype(self) -> None:
        ...
        self.assertIn("setQueueRefreshButtonBusy(false)", app_refresh_js)
        ...
        self.assertIn('<h2>Publish Guard Evidence</h2>', html)
        self.assertIn('<h2>Publish Parked Outputs</h2>', html)
        ...
        self.assertIn("movie_filter_options: collectRenameMovieFilterOptions()", rename_view_js)
        ...
        self.assertIn("Movie filter terms are always sent to the backend cleaner", rename_view_js)
        ...
        self.assertIn('renameView.saveRenameCleaningFilterState("Rename filters saved with Settings for this browser.")', settings_view_js)
        self.assertIn("Rename cleaning filters were saved to browser storage.", settings_view_js)
        self.assertNotIn("settings-rename-use-editable-cleaning-filters", html)
        self.assertIn("Movie filter terms are always active", html)
        ...
        self.assertIn("window.setInterval(() => refreshAll({ automatic: true }), 4000)", js)
