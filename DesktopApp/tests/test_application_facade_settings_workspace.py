...
class ApplicationFacadeSettingsWorkspaceTests(unittest.TestCase):
    def test_settings_workspace_redacts_tokens_and_reports_validation(self) -> None:
        ...
        self.assertEqual(size_guard_field["label"], "Output Size Check")
        self.assertEqual(size_guard_field["short_label"], "Size Check")
        ...
        self.assertEqual(threshold_mode_field["label"], "Enforcement Mode")
        self.assertEqual(threshold_mode_field["short_label"], "Enforcement")
        ...
        self.assertEqual(movie_bitrate_field["label"], "Movie max bitrate for direct copy")
        ...
        self.assertEqual(tv_bitrate_field["label"], "TV max bitrate for direct copy")
