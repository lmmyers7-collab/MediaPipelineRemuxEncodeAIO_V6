...
def _change_ledger_payload(root: Path) -> dict[str, object]:
    return {
        ...
        "python_impact": {
            ...
            "groups": [
                {"group": "app", "summary": "app: 1 Python file(s)", "files": ["app/maintenance/change_ledger.py"]},
                {
                    "group": "desktop_api",
                    "summary": "desktop_api: 1 Python file(s)",
                    "files": ["DesktopApp/mediapipeline_desktop_app/api/read_payloads_workspace.py"],
                },
                {"group": "tests", "summary": "tests: 1 Python file(s)", "files": ["DesktopApp/tests/test_fixture.py"]},
            ],
        },
        "coverage": {
            "scope": "worktree",
            ...
            "covered_paths": [],
            "uncovered_paths": [],
            "packet_paths_considered": ["changes/unreleased/MP-CHANGE-SMOKE-001.json"],
            "errors": [],
        },
        "summary_lines": [
        ...
        "source_paths": [
            ...
            {"path": "changes/unreleased", "exists": True, "stale": False},
            {"path": "changes/released", "exists": True, "stale": False},
        ],
        "hygiene": {
        ...
        "rows": [
            {
                ...
                "source_path": "changes/unreleased/MP-CHANGE-SMOKE-001.json",
            ...
            },
            {
                ...
                "source_path": "changes/released/0.0.9/MP-CHANGE-SMOKE-002.json",
                ...
                "files_touched": ["DesktopApp/tests/test_fixture.py"],
                "python_impact": {
                    "file_count": 1,
    ...
    return browser_cdp_runner_prelude() + textwrap.dedent(
        ...
        function changeLedgerScript(data) {
          ...
          (async () => {
            ...
            requireText("maintenance-change-ledger-detail", ["Add Maintenance Change Ledger", "Affected Python scripts:", "app/maintenance/change_ledger.py"]);
            ...
            setValue("maintenance-change-ledger-search", "app/maintenance/change_ledger.py");
            window.mediaPipelineMaintenanceView.renderChangeLedgerRows();
            requireText("maintenance-change-ledger-table-status", ["1/2 shown"]);
...
class WebViewBrowserMaintenanceChangeLedgerSmokeTests(unittest.TestCase):
