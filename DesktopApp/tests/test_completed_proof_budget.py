...
from app.completed.policy import completed_record_to_row
from mediapipeline_desktop_app.api.read_payloads_inventory import (
...
class CompletedManifestProofBudgetTests(unittest.TestCase):
    def test_summary_mode_skips_all_live_proof_and_marks_deferred(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            with patch("app.completed.manifest.annotate_completed_output_health") as spy:
