...
from mediapipeline_desktop_app.network.protocol import ClaimResponse, DoneRequest
...
class NetworkDoneReleaseTests(unittest.TestCase):
    def test_worker_mark_done_posts_terminal_payload_and_clears_active_job(self) -> None:
        ...
        with self.assertLogs("mediapipeline_desktop_app.network.worker", level="INFO") as logs:
