...
from .service_process_spawn import (
...
from .service_runner_protocols import ProcessSpawnServiceProtocol


def _stop_started_process_after_launch_failure(
    service: ProcessSpawnServiceProtocol,
...
def spawn_process_for_service(
    ...
    *,
    ...
    kwargs = build_spawn_kwargs(
        ...
        environment=service._build_launch_environment(),
