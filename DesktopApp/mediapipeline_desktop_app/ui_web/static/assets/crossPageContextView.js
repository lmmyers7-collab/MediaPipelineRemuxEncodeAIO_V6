(function () {
  ...
  window.crossPageConflictStatus = crossPageConflictStatus;
  window.crossPageSampleRows = crossPageSampleRows;
  window.crossPageSampleStatus = crossPageSampleStatus;
  ...
  window.sampleValidationCutoverStatus = sampleValidationCutoverStatus;
  window.sampleValidationCutoverSummaryLines = sampleValidationCutoverSummaryLines;
  window.sampleValidationCutoverDetailLines = sampleValidationCutoverDetailLines;
  window.sampleValidationGapPayload = sampleValidationGapPayload;
  window.sampleValidationGapRows = sampleValidationGapRows;
  window.sampleValidationGapStatus = sampleValidationGapStatus;
  window.sampleValidationGapSummaryLines = sampleValidationGapSummaryLines;
  window.sampleValidationGapDetailLines = sampleValidationGapDetailLines;
  window.sampleValidationRunbookPayload = sampleValidationRunbookPayload;
  window.sampleValidationRunbookRows = sampleValidationRunbookRows;
  window.sampleValidationRunbookStatus = sampleValidationRunbookStatus;
  ...
  window.sampleValidationRunbookDetailLines = sampleValidationRunbookDetailLines;
  window.sampleValidationSampleSetRows = sampleValidationSampleSetRows;
  window.sampleValidationSampleSetStatus = sampleValidationSampleSetStatus;
  window.sampleValidationSampleSetSummaryLines = sampleValidationSampleSetSummaryLines;
  window.sampleValidationSampleSetCoverageLine = sampleValidationSampleSetCoverageLine;
  window.sampleValidationSampleSetDetailLines = sampleValidationSampleSetDetailLines;
  window.sampleValidationSampleSetKey = sampleValidationSampleSetKey;
  window.sampleValidationCategorySummaryStatus = sampleValidationCategorySummaryStatus;
  window.sampleValidationCategorySummaryLines = sampleValidationCategorySummaryLines;
  window.sampleValidationCategorySummaryDetailLines = sampleValidationCategorySummaryDetailLines;
  window.sampleValidationExecutionRows = sampleValidationExecutionRows;
  window.sampleValidationExecutionStatus = sampleValidationExecutionStatus;
  ...
  window.sampleValidationCompletedPacketStatus = sampleValidationCompletedPacketStatus;
  ...
  window.sampleValidationCompletedPacketSummaryLines = sampleValidationCompletedPacketSummaryLines;
  window.sampleValidationCompletedPacketDetailLines = sampleValidationCompletedPacketDetailLines;
  window.sampleValidationCompletedPacketMarkdownLines = sampleValidationCompletedPacketMarkdownLines;
  window.sampleValidationAcceptanceGateStatus = sampleValidationAcceptanceGateStatus;
  window.sampleValidationAcceptanceGateSummaryLines = sampleValidationAcceptanceGateSummaryLines;
  window.sampleValidationAcceptanceGateDetailLines = sampleValidationAcceptanceGateDetailLines;
  window.sampleValidationRecordReviewStatus = sampleValidationRecordReviewStatus;
  window.sampleValidationRecordReviewSummaryLines = sampleValidationRecordReviewSummaryLines;
  window.sampleValidationRecordReviewDetailLines = sampleValidationRecordReviewDetailLines;
