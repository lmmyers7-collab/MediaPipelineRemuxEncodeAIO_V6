(function () {
  ...
  function settingsOperatorTrustLines(settings) {
    ...
    const lines = [
      ...
      `- Remux/copy bitrate ceilings: <=${trustConfigValue(config, "Route1080pBucketMaxHeight", "1200")}p uses ${trustConfigValue(config, "Route1080pMaxVideoBitrateMbps", "20")} Mbps; >=${trustConfigValue(config, "Route4KBucketMinHeight", "1800")}p uses ${trustConfigValue(config, "Route4KMaxVideoBitrateMbps", "35")} Mbps; unknown-height fallback movie=${trustConfigValue(config, "MovieRouteMaxVideoBitrateMbps", "35")} Mbps / TV=${trustConfigValue(config, "TVRouteMaxVideoBitrateMbps", "18")} Mbps.`,
  ...
  function buildSettingsOverviewRows(config) {
    ...
    [
      ...
      ["Route1080pBucketMaxHeight", "1080-ish bucket max height"],
      ["Route1080pMaxVideoBitrateMbps", "1080-ish max bitrate Mbps"],
      ["Route4KBucketMinHeight", "4K bucket min height"],
