(function () {
  ...
  function changeLedgerSummaryLines(ledger) {
    ...
    lines.push(
      ...
      "- Structured change packets under changes/ feed this Maintenance ledger and generated change-control docs.",
  ...
  function renderDependencyAtlasResult(result) {
    ...
    const lines = [
      ...
      `Safe next action: ${result?.ok ? "Open V6_dependency_atlas/V6_dependency_atlas.html or V6_dependency_atlas/V6_dependency_atlas.png from the repository root." : "Read errors and Diagnostics before trusting the atlas files."}`,
  ...
  async function runDependencyAtlas() {
    ...
    setText("dependency-atlas-detail", "Generating dependency atlas artifacts through backend tooling. This updates files under V6_dependency_atlas only.");
    try {
