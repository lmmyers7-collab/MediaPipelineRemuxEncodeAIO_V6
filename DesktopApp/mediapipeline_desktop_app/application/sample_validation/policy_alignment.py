...
def sample_validation_evidence_gap_payload(
    ...
    if blocked_count:
        ...
        safe_next_action = "Required pilot proof is present. Keep V5 fallback and rerun representative samples after media-policy changes."
    summary_lines = [
...
def sample_validation_validation_audit_payload(
    ...
    rows = [
        ...
        row(
            ...
            _clean_text(cutover_gate.get("safe_next_action")) or "Keep V5 fallback until cutover gate evidence is ready and current.",
    ...
    if blocked_count:
        ...
        safe_next_action = "Run the next supervised representative sample through backend-owned Launch while keeping V5 fallback."
