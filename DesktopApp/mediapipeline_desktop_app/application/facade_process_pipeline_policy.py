...
PIPELINE_EXTRA_ARGS_ERROR = "Extra pipeline arguments require allow_extra_args=true."
...
def pipeline_start_schedule_gate_result(schedule_gate: dict[str, Any]) -> CommandResult:
    ...
    return CommandResult(
        ...
        data={"schedule": json_safe(schedule_gate.get("data") or {})},
    )
    ...
    *,
    ...
    return CommandResult(
        ...
        data=pipeline_start_success_data(
            ...
            requested_mode=requested_mode,
            schedule_data=json_safe(schedule_data or {}),
            pid=pid,
