...
.EXAMPLE
    .\scripts\release\Backup-PreOverhaul.ps1 -Destination 'D:\Backups\MediaPipeline\v6-pre-overhaul-2026-05-28'

.EXAMPLE
    .\scripts\release\Backup-PreOverhaul.ps1 -Destination 'E:\Archive\mpv6' -SkipReleaseBuild -DryRun
#>
[CmdletBinding()]
param(
