...
SKIP_REFERENCE_PATHS = {
    ...
    "DesktopApp/tests/test_architecture_guardrails.py",
    "DesktopApp/tests/test_legacy_removal_readiness.py",
    "tests/tooling/test_lint_naming.py",
}
...
LEGACY_FAMILIES: dict[str, LegacyFamily] = {
    "config_schema": LegacyFamily(
        ...
        file_globs=(
            ...
            "DesktopApp/mediapipeline_desktop_app/config_schema_*.py",
        ),
        search_terms=(
            "config_schema_",
            "config_schema*.py",
            "config_schema import",
            "mediapipeline_desktop_app.config_schema",
        ),
    ),
    "command_payloads": LegacyFamily(
        ...
        file_globs=(
            ...
            "DesktopApp/mediapipeline_desktop_app/api/command_payloads_*.py",
        ),
        search_terms=(
            "command_payloads",
    ...
    "python_facades": LegacyFamily(
        ...
        file_globs=("DesktopApp/mediapipeline_desktop_app/application/facade_*.py",),
        search_terms=(
            "DesktopApp/mediapipeline_desktop_app/application/facade_",
            "DesktopApp\\mediapipeline_desktop_app\\application\\facade_",
            "application/facade_",
            "application\\facade_",
            "mediapipeline_desktop_app.application.facade_",
            "from .facade_",
            "import .facade_",
    ...
    "python_services": LegacyFamily(
        ...
        file_globs=("DesktopApp/mediapipeline_desktop_app/service_*.py",),
        search_terms=(
            "DesktopApp/mediapipeline_desktop_app/service_",
            "DesktopApp\\mediapipeline_desktop_app\\service_",
            "mediapipeline_desktop_app.service_",
            "from .service_",
            "import .service_",
        ),
    ),
...
def _reference_category(path: str) -> str:
    ...
    if rel.startswith("scripts/release/") or rel in LEGACY_FAMILIES["root_launchers"].file_globs:
        return "release"
    if rel.startswith("DesktopApp/tauri_shell/"):
        return "package"
    if (
        rel.startswith("tests/")
        or rel.startswith("DesktopApp/tests/")
