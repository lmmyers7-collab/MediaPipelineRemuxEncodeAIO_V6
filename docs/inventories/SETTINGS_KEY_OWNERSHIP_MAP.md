...
| `QueueLaunchSnapshotFreshnessSeconds` | Medium | Blank Run Once queue-snapshot authority window for both `produced_at` and file age (default 60 seconds; 15–3600). Stale or clock-skewed evidence stays advisory. | Advanced Settings / Long-Run Reliability | `test_application_facade_process_launch.py`, `test_service_config_numeric_policy.py` |
