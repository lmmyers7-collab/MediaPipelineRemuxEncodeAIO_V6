...
Total document-scoped element IDs: **2151** across **2 reachable HTML surfaces**. The inventory contains **2151 unique `(surface, id)` keys** and **2151 globally distinct ID values**.

| Surface | Source | Render mode | ID instances | Unique IDs |
| --- | --- | --- | ---: | ---: |
| `main` | `apps/desktop/webview/static/index.html` | backend-expanded partials | 2143 | 2143 |
