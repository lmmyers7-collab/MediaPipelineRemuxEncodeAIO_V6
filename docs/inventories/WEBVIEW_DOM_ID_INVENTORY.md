...
Total document-scoped element IDs: **2158** across **2 reachable HTML surfaces**. The inventory contains **2158 unique `(surface, id)` keys** and **2158 globally distinct ID values**.

| Surface | Source | Render mode | ID instances | Unique IDs |
| --- | --- | --- | ---: | ---: |
| `main` | `apps/desktop/webview/static/index.html` | backend-expanded partials | 2150 | 2150 |
| `assets/pipelineLogWindow.html` | `apps/desktop/webview/static/assets/pipelineLogWindow.html` | standalone auxiliary document | 8 | 8 |
...
Generated by `apps/desktop/runtime/Python/python.exe ops/scripts/dev/run-python-tool.py mediapipeline.tools.dev.generate_webview_inventory_docs`. IDs are sorted within each document and remain document-scoped so auxiliary surfaces cannot disappear behind a main-page total.

<!-- BEGIN GENERATED DOM ID MANIFEST -->
### `main`

Source: `apps/desktop/webview/static/index.html`
...
completed-current-output-bitrate-column
completed-current-output-details-toggle
completed-current-output-heading
completed-current-output-size-column
...
completed-history-bitrate-column
...
completed-output-strip-details-toggle
...
home-advanced-failure-quick-link
...
home-pending-count
home-primary-failure-quick-link
home-promotion-entry-message
home-queue-snapshot
home-queue-snapshot-status
home-quick-controls-queue
...
home-recent-output-review-completed
home-recovery-banner
home-refresh-button
home-run-state-handoff
home-runtime-open-status
home-sample-validation-accepted-record-review-diagnostics
home-sample-validation-decision-review-completed
home-sample-validation-decision-review-diagnostics
home-sample-validation-decision-review-pending
home-sample-validation-records-review-completed
home-sample-validation-records-review-diagnostics
home-sample-validation-records-review-pending
...
metrics-encode-route-quick-link
...
metrics-remux-count
metrics-remux-route-quick-link
metrics-route-bars
...
network-coordinator-open-cluster-log
network-coordinator-open-settings
...
network-local-api
network-mode-model
network-mode-model-open-cluster-log
...
network-standalone-open-run-logs
...
network-worker-open-run-logs
network-worker-open-settings
...
pipeline-priority-export-id
pipeline-priority-export-status
...
reset-layout-btn
run-monitor-announcer
run-monitor-audio-body
run-monitor-audio-state
run-monitor-authority
run-monitor-counts
run-monitor-detail
run-monitor-detail-heading
run-monitor-detail-state
run-monitor-ended
run-monitor-evidence
run-monitor-file-outcome
run-monitor-freshness
run-monitor-identity-evidence
run-monitor-items
run-monitor-items-count
run-monitor-items-heading
run-monitor-items-help
run-monitor-items-toggle
run-monitor-last-known
run-monitor-last-known-body
run-monitor-last-known-meta
run-monitor-mode
run-monitor-open-queue
run-monitor-outcome
run-monitor-output
run-monitor-output-evidence
run-monitor-recovery
run-monitor-refresh
run-monitor-route-summary
run-monitor-routes
run-monitor-sidecars
run-monitor-source
run-monitor-stage-list
run-monitor-stage-summary
run-monitor-started
run-monitor-state
run-monitor-stop-after-current
run-monitor-stop-state
run-monitor-subtitle-body
run-monitor-subtitle-state
run-monitor-summary
run-monitor-summary-heading
run-monitor-terminal-links
run-monitor-updated
run-monitor-workers
run-monitor-workers-count
run-monitor-workers-heading
...
Source: `apps/desktop/webview/static/assets/pipelineLogWindow.html`

Count: 8

```text
pipeline-log-window-detail
pipeline-log-window-follow
pipeline-log-window-mode
pipeline-log-window-refresh-button
pipeline-log-window-status
pipeline-log-window-text
pipeline-log-window-title
pipeline-log-window-updated
```
