...
**Functions:** `Backup-PublishSidecarForReveal`, `Complete-PublishMediaReveal`, `Get-PublishSidecarBackupPath`, `Move-PublishSidecarBackupIntoPlace`, `New-PublishPartialMediaPath`, `New-PublishSidecarBackupResult`, `Remove-PublishPartialMedia`, `Remove-PublishSidecarBackup`, `Restore-PublishSidecarAfterRevealFailure`, `Test-PublishSidecarBackupReadyForReveal`
