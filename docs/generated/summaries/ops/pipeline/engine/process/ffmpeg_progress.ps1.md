...
sha256: a53a6ef4ee3e2f5de950aeeb9a04e4bef0e617353d2f76edd76eb981f1ef5aab
---
# `ops/pipeline/engine/process/ffmpeg_progress.ps1`

**Purpose:** (no .SYNOPSIS block)

**Functions:** `Get-FFmpegWasteGuardContextValue`, `Get-MkvmergeProgressPercentFromLine`, `Get-MkvmergeWarningClassification`, `Invoke-FFmpegWithProgress`, `Invoke-MkvmergeWithProgress`
