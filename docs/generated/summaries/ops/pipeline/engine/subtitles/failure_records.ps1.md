...
**Functions:** `ConvertTo-SubtitleFailureEvidence`, `Get-SubtitleFailureProperty`, `Get-SubtitleFailureStreamIndex`, `Get-SubtitleFailureStreamText`, `Get-SubtitleFailureText`, `Register-SubtitleExtractionFailure`, `Register-Tx3gSubtitleFailure`
