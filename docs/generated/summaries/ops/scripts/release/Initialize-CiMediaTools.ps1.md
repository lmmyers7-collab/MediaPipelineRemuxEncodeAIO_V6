...
sha256: 1ddc269c64c40d6aa268671f1b9ee356ee07233edbe9b5bcca9253543d7b0d17
---
# `ops/scripts/release/Initialize-CiMediaTools.ps1`

**Purpose:** (no .SYNOPSIS block)

**Functions:** `Copy-DirectoryContents`, `Find-ExecutableInRoots`, `Get-ToolRoots`, `Install-MissingPackages`, `Invoke-CheckedCommand`, `Resolve-CommandSource`, `Resolve-Executable`, `Resolve-ProvisionSource`, `Resolve-RepoRoot`
