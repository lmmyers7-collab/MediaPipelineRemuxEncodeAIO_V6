...
sha256: efc10c8b1cd9c6242afae8f49100430ef8cfa2a25843003472b55c64ca53c7aa
---
...
_Edit the source, not this file. Regenerate with `apps/desktop/runtime/Python/python.exe ops/scripts/dev/run-python-tool.py mediapipeline.tools.dev.refresh_summaries --paths src/mediapipeline/desktop/application/dto_workspaces.py`._
