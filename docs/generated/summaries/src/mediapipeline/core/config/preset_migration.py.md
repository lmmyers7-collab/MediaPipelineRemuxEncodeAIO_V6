...
**Public symbols:** `effective_decision_policy_from_legacy_or_preset`, `effective_decision_policy_from_preset_v2`, `legacy_config_patch_from_preset_v2`, `preset_v2_from_legacy_config`
