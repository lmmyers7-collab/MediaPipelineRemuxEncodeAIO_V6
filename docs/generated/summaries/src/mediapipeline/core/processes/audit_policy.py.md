...
**Public symbols:** `audit_missing_library_root_result`, `audit_start_active_work_result`, `audit_start_config_blocked_result`, `audit_start_exception_result`, `audit_start_success_data`, `audit_start_success_message`, `audit_start_success_result`, `audit_stop_active_work_result`, `audit_stop_confirm_required_result`, `audit_stop_exception_result`, `audit_stop_success_result`, `resolve_audit_library_root`, `resolve_audit_library_roots`
