---
file: src/mediapipeline/core/diagnostics/autonomy_health_publish.py
summary_schema: 2
...
**Purpose:** Python implementation for autonomy health publish.
...
_Edit the source, not this file. Regenerate with `apps/desktop/runtime/Python/python.exe ops/scripts/dev/run-python-tool.py mediapipeline.tools.dev.refresh_summaries --paths src/mediapipeline/core/diagnostics/autonomy_health_publish.py`._
