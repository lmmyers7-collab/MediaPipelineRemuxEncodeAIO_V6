...
sha256: 5382ca3804ef438b26c8e247787e30cdce9bb35b18aad7d83ce282ed87e5d691
---
# `src/mediapipeline/core/rename/tv.py`

**Purpose:** (no module docstring)

**Public functions:** `apply_tv_episode_title_template()`, `build_auto_tv_rename_name()`, `build_manual_tv_hierarchy_destination()`, `build_tv_rename_name()`, `clean_pipeline_tv_name_part()`, `collective_tv_filter_terms()`, `extract_confident_tv_episode_title()`, `normalize_tv_filter_options()`, `normalize_tv_filter_terms()`, `rename_tv_filter_default_terms()`, `resolve_tv_folder_season_info()`, `strip_tv_release_groups()`
