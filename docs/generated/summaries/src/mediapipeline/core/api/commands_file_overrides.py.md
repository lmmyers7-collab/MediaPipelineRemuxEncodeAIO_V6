...
**Classes:** `LocalApiFileOverridesCommandPayloadMixin`
**In-repo imports:** `mediapipeline.core.orchestration.runner`, `mediapipeline.core.processes.source_path_policy`, `mediapipeline.core.queue.file_overrides`
