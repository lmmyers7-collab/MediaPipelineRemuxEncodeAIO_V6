...
**Public symbols:** `collect_active_markdown_files`, `DocFinding`, `findings_for_files`, `findings_for_text`, `main`, `missing_moved_doc_targets`, `missing_required_active_docs`, `normalize_path`, `render_findings`
