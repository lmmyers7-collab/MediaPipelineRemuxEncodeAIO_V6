...
**Public symbols:** `compare_sarif_evidence`, `fetch_pinned_ruleset`, `main`, `normalized_sarif_digest`, `ruleset_semantic_digest`, `RulesetEvidence`, `SarifComparison`, `SarifComparisonEntry`, `SarifDigest`, `SarifProvenance`, `stamp_sarif_provenance`
