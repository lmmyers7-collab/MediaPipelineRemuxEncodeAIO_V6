...
sha256: 0231ec68676349d981e49ce88b40c79aaca72d278ca7e8aa1567bc3995211b0b
---
# `src/mediapipeline/tools/dev/audit_checks.py`

**Purpose:** Shared audit/check definitions for local hooks, CI, and release gates.

**Public symbols:** `AuditCheck`, `AuditCheckResult`, `check_to_dict`, `command_for_check`, `main`, `result_to_dict`, `run_check`, `run_suite`, `subprocess_environment`, `suite_checks`, `suite_names`, `suite_to_dict`
