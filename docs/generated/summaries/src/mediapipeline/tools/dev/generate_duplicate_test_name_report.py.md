...
**Purpose:** Generate a focused exact duplicate Python test-name report.

**Classes:** `TestDefinition`
**Public functions:** `check_current()`, `collect_definitions_from_tree()`, `collect_test_definitions()`, `duplicate_groups()`, `iter_test_files()`, `main()`, `render_duplicate_test_name_report()`, `repo_rel()`, `write_if_changed()`
