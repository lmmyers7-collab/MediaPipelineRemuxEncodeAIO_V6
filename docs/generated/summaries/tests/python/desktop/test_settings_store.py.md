---
file: tests/python/desktop/test_settings_store.py
pipeline_stage: n/a
...
**Classes:** `SettingsStoreTests`, `_StoreDummyService`
**In-repo imports:** `mediapipeline.core.config.load`, `mediapipeline.core.config.settings_store`, `mediapipeline.core.kernel.config_locations`, `mediapipeline.desktop.models`, `mediapipeline.tools.paths`
