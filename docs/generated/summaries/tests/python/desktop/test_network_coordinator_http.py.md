...
**Purpose:** Python implementation for test network coordinator http; exposes NetworkCoordinatorHttpTests.

**Public symbols:** `NetworkCoordinatorHttpTests`
...
**HTTP routes:** `/api/claim`, `/api/claim?worker_id=worker`, `/api/done`, `/api/done:`, `/api/heartbeat`, `/api/log`, `/api/workers`
