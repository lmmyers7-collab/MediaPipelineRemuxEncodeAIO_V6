...
**Purpose:** Rename Workbench static + backend tests.

**Classes:** `RenameBackendBrowseModeTests`, `RenameBackendPathDialogScriptTests`, `RenameWorkbenchHtmlTests`, `RenameWorkbenchJsTests`
