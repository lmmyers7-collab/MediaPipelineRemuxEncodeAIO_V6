---
file: app/contracts/runtime_evidence.py
...
---
# `app/contracts/runtime_evidence.py`
...
_Edit the source, not this file. Regenerate with `python scripts/dev/refresh_summaries.py --paths app/contracts/runtime_evidence.py`._
