...
#   Format-NativeCommandLine    — Modules\PathHelpers.ps1
#   Test-IsUncPath              — Modules\PathHelpers.ps1
#
...
if (-not (Get-Command -Name New-NativeCommandResult -ErrorAction SilentlyContinue)) {
    $nativeContractsPath = Join-Path $PSScriptRoot 'NativeProcessContracts.ps1'
