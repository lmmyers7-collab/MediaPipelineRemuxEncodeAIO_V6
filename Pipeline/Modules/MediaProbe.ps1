# ==============================================================================
# Modules\MediaProbe.ps1
# ==============================================================================
# ffprobe-driven media inspection helpers extracted from
...
#   Invoke-NativeCommand      — Modules\Native.ps1
#   Start-StopAwareSleep      — Modules\Native.ps1
#   Get-FFprobeFailureCode    — Modules\FailureCodes.ps1
