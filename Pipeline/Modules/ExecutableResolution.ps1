# ==============================================================================
# Modules\ExecutableResolution.ps1
# ==============================================================================
# Portable runtime tool discovery helpers.
#
# Dot-sourced from MediaPipeline_chatgpt.ps1. Resolve-BundledExecutable reads
# $scriptDir and $script:AllowSystemTools at call time, so the module can load
# before configuration while preserving the existing startup order.
# ==============================================================================
