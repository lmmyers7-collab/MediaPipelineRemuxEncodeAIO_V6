# ==============================================================================
# Modules\OutputPathPlanning.ps1
# ==============================================================================
# Output destination planning and path capability checks.
#
# Dot-sourced from MediaPipeline_chatgpt.ps1. These helpers read path and
# naming configuration from the main script scope at call time.
# ==============================================================================
