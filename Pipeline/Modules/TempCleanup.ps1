# ==============================================================================
# Modules\TempCleanup.ps1
# ==============================================================================
# Startup cleanup for stale pipeline scratch artifacts.
#
# Dot-sourced from MediaPipeline_chatgpt.ps1. Clear-OldTempFiles reads
# $script:processingDir at call time and only removes the existing temp-name
# patterns that the main script has used historically.
# ==============================================================================
