...
$pipelineFiles = @($main) + $moduleFiles
...
$rerunIdentity = Join-Path $root 'Modules\RerunSourceIdentity.ps1'
...
$serviceAppState = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_app_state.py'
$serviceAppSchedule = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_app_schedule.py'
$serviceAuditRerun = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_audit_rerun.py'
$serviceAuditRerunCsv = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_audit_rerun_csv.py'
$serviceAuditRerunExport = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_audit_rerun_export.py'
$serviceAuditRerunIo = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_audit_rerun_io.py'
$serviceAuditRerunMetadata = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_audit_rerun_metadata.py'
$serviceAuditRerunRecords = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_audit_rerun_records.py'
$serviceCompleted = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_completed.py'
$serviceCompletedBackfill = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_completed_backfill.py'
$serviceCompletedManifest = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_completed_manifest.py'
$serviceConfig = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_config.py'
$serviceConfigDocumentRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_config_document_runner.py'
$serviceConfigSaveRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_config_save_runner.py'
$serviceConfigNumericPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_config_numeric_policy.py'
$serviceConfigOptionPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_config_option_policy.py'
$serviceConfigPathWarnings = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_config_path_warnings.py'
$serviceConfigPreview = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_config_preview.py'
$serviceConfigValidation = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_config_validation.py'
$serviceConfigValueChecks = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_config_value_checks.py'
$serviceConstants = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_constants.py'
$serviceFailureCleanup = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_failure_cleanup.py'
$serviceFailureMarkers = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_failure_markers.py'
$serviceFileOpen = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_file_open.py'
$serviceFileOpenPlan = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_file_open_plan.py'
$serviceFolderPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_folder_policy.py'
$serviceFolderPolicyContracts = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_folder_policy_contracts.py'
$serviceFolderPolicyIo = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_folder_policy_io.py'
$serviceFolderPolicyProbe = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_folder_policy_probe.py'
$servicePendingPublish = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_pending_publish.py'
$servicePendingPublishFormat = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_pending_publish_format.py'
$servicePendingPublishManifest = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_pending_publish_manifest.py'
$servicePendingPublishManifestRows = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_pending_publish_manifest_rows.py'
$servicePendingPublishPaths = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_pending_publish_paths.py'
$servicePathDefaults = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_path_defaults.py'
$servicePathHostRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_path_host_runner.py'
$servicePathLayout = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_path_layout.py'
$servicePathResolutionRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_path_resolution_runner.py'
$servicePathStateMigration = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_path_state_migration.py'
$servicePaths = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_paths.py'
$serviceProcesses = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_processes.py'
$serviceProcessActiveJobs = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_active_jobs.py'
$serviceProcessActiveJobRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_active_job_runner.py'
$serviceProcessControlFlags = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_control_flags.py'
$serviceProcessControlRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_control_runner.py'
$serviceProcessKill = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_kill.py'
$serviceProcessLaunchCleanup = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_launch_cleanup.py'
$serviceProcessLaunchPlans = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_launch_plans.py'
$serviceProcessLaunchRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_launch_runner.py'
$serviceProcessReadiness = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_readiness.py'
$serviceProcessRuntimeArtifacts = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_runtime_artifacts.py'
$serviceProcessRuntimeRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_runtime_runner.py'
$serviceProcessSpawn = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_spawn.py'
$serviceProcessSpawnRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_process_spawn_runner.py'
$serviceQueue = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_queue.py'
$serviceQueueDryRun = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_queue_dry_run.py'
$serviceQueueDryRunRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_queue_dry_run_runner.py'
$serviceQueuePreviewBuilder = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_queue_preview_builder.py'
$serviceQueuePriority = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_queue_priority.py'
$serviceQueueSnapshot = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_queue_snapshot.py'
$serviceRelease = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_release.py'
$serviceReleasePlan = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_release_plan.py'
$serviceReleaseResult = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_release_result.py'
$serviceRename = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename.py'
$serviceRenameApply = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename_apply.py'
$serviceRenameApplyRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename_apply_runner.py'
$serviceRenameDiscovery = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename_discovery.py'
$serviceRenamePlanPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename_plan_policy.py'
$serviceRenamePlanner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename_planner.py'
$serviceRenamePreview = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename_preview.py'
$serviceRenamePreviewRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename_preview_runner.py'
$serviceRenameTv = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename_tv.py'
$serviceRenameTvFolder = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_rename_tv_folder.py'
$serviceStatus = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status.py'
$serviceStatusActiveJobs = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status_active_jobs.py'
$serviceStatusEvents = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status_events.py'
$serviceStatusFiles = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status_files.py'
$serviceStatusPresentation = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status_presentation.py'
$serviceStatusProgress = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status_progress.py'
$serviceStatusReaders = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status_readers.py'
$serviceStatusSnapshotRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status_snapshot_runner.py'
$serviceStatusSummary = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status_summary.py'
$serviceStatusSummarySections = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_status_summary_sections.py'
$serviceTelemetry = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_telemetry.py'
$serviceTelemetryHealth = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_telemetry_health.py'
$serviceTelemetryNvidia = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_telemetry_nvidia.py'
$serviceTelemetrySystem = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\service_telemetry_system.py'
$subprocessRunner = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\subprocess_runner.py'
$settingsRiskPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\settings_risk_policy.py'
$settingsRiskPolicyRules = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\settings_risk_policy_rules.py'
$facadeCompleted = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_completed.py'
$facadeCompletedPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_completed_policy.py'
$facadeCompletedOpen = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_completed_open.py'
$facadeCompletedOpenPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_completed_open_policy.py'
$facadeMaintenance = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_maintenance.py'
$facadeMaintenanceBackfill = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_maintenance_backfill.py'
$facadeMaintenanceCommands = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_maintenance_commands.py'
$facadeMaintenanceCommandPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_maintenance_command_policy.py'
$facadeMaintenancePolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_maintenance_policy.py'
$facadeMaintenanceRelease = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_maintenance_release.py'
$facadeFailures = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_failures.py'
$facadeFailuresPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_failures_policy.py'
$facadeAudit = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_audit.py'
$facadeAuditPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_audit_policy.py'
$facadePendingPublish = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_pending_publish.py'
$facadePendingPublishPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_pending_publish_policy.py'
$facadeQueue = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_queue.py'
$facadeQueuePolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_queue_policy.py'
$facadeSchedule = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_schedule.py'
$facadeSchedulePolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_schedule_policy.py'
$facadeSettings = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_settings.py'
$facadeSettingsPatch = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_settings_patch.py'
$facadeSettingsPatchCandidate = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_settings_patch_candidate.py'
$facadeSettingsPatchPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_settings_patch_policy.py'
$facadeSettingsPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_settings_policy.py'
$facadeProcessPipeline = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_pipeline.py'
$facadeProcessPipelinePolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_pipeline_policy.py'
$facadeProcessAudit = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_audit.py'
$facadeProcessAuditPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_audit_policy.py'
$facadeProcessRerun = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_rerun.py'
$facadeProcessRerunPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_rerun_policy.py'
$facadeProcessControl = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_control.py'
$facadeProcessControlPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_control_policy.py'
$facadeProcessSchedule = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_schedule.py'
$facadeProcessSchedulePolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_schedule_policy.py'
$facadeProcessGuard = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_guard.py'
$facadeProcessGuardPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_process_guard_policy.py'
$facadeDiagnostics = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_diagnostics.py'
$facadeDiagnosticsPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_diagnostics_policy.py'
$facadeDiagnosticsOpenPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_diagnostics_open_policy.py'
$facadeStatus = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_status.py'
$facadeStatusPolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_status_policy.py'
$facadeRename = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_rename.py'
$facadeRenamePolicy = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\application\facade_rename_policy.py'
$app = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\app.py'
$appBootstrap = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\app_bootstrap.py'
$controllersInit = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\__init__.py'
$appStateController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\app_state_controller.py'
$auditActionsController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\audit_actions_controller.py'
$auditController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\audit_controller.py'
$auditTableController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\audit_table_controller.py'
$completedActionsController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\completed_actions_controller.py'
$completedAnalyticsController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\completed_analytics_controller.py'
$completedController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\completed_controller.py'
$completedTableController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\completed_table_controller.py'
$diagnosticsController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\diagnostics_controller.py'
$failureActionsController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\failure_actions_controller.py'
$failureController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\failure_controller.py'
$failureTableController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\failure_table_controller.py'
$feedbackController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\feedback_controller.py'
$fileActionsController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\file_actions_controller.py'
$folderPolicyController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\folder_policy_controller.py'
$homeController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\home_controller.py'
$homeSummaryController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\home_summary_controller.py'
$maintenanceController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\maintenance_controller.py'
$navigationController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\navigation_controller.py'
$navigationSidebarController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\navigation_sidebar_controller.py'
$networkController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\network_controller.py'
$notificationController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\notification_controller.py'
$pendingPublishController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\pending_publish_controller.py'
$pipelineController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\pipeline_controller.py'
$processLifecycleController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\process_lifecycle_controller.py'
$queueController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\queue_controller.py'
$queueDragController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\queue_drag_controller.py'
$queueFileActionsController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\queue_file_actions_controller.py'
$queueMetricsController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\queue_metrics_controller.py'
$queuePriorityController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\queue_priority_controller.py'
$queueRefreshController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\queue_refresh_controller.py'
$queueTableController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\queue_table_controller.py'
$queueThumbnailController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\queue_thumbnail_controller.py'
$releaseController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\release_controller.py'
$renameController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\rename_controller.py'
$renameTableController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\rename_table_controller.py'
$rerunController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\rerun_controller.py'
$scheduleController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\schedule_controller.py'
$settingsController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\settings_controller.py'
$settingsFormController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\settings_form_controller.py'
$settingsPersistenceController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\settings_persistence_controller.py'
$settingsProfileController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\settings_profile_controller.py'
$statusPresentationController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\status_presentation_controller.py'
$statusServerController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\status_server_controller.py'
$telemetryController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\telemetry_controller.py'
$workGuardController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\work_guard_controller.py'
$workerController = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\controllers\worker_controller.py'
$workers = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\workers.py'
$priorityMarkers = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\priority_markers.py'
$configSchema = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\config_schema.py'
$pipelineEventsContract = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\contracts\pipeline_events.py'
$progressContract = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\contracts\progress.py'
$activeJobContract = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\contracts\active_job.py'
$controlFlagContract = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\contracts\control_flag.py'
$pendingPublishContract = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\contracts\pending_publish.py'
$appShellView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\app_shell.py'
$homeView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\home.py'
$liveView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\live.py'
$queueView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\queue.py'
$libraryView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\library.py'
$diagnosticsView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\diagnostics.py'
$diagnosticsDrawerView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\diagnostics_drawer.py'
$maintenanceView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\maintenance.py'
$renameView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\rename.py'
$rerunView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\rerun.py'
$scheduleView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\schedule.py'
$settingsView = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\settings.py'
$viewsInit = Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\views\__init__.py'
...
$releaseBuilder = Join-Path $projectRoot 'Build-MediaPipelineRemuxEncodeAIO-Release.ps1'
$environmentVerifier = Join-Path $projectRoot 'Verify-MediaPipelineRemuxEncodeAIO-Environment.ps1'
$releaseVerifier = Join-Path $projectRoot 'Test-MediaPipelineRemuxEncodeAIO-Release.ps1'
...
if ($python) {
    $pythonCompileTargets = @($subtitle) + @(
        Get-ChildItem -LiteralPath (Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app') -Filter '*.py' -File -Recurse |
...
$pipelineText = (@($mainText) + $moduleTexts) -join [Environment]::NewLine
...
$modelsText = Get-Content -LiteralPath (Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\models.py') -Raw
$modelsCoreText = Get-Content -LiteralPath (Join-Path $projectRoot 'DesktopApp\mediapipeline_desktop_app\models_core.py') -Raw
...
$subtitleFacadeText = Get-Content -LiteralPath (Join-Path $root 'Modules\Subtitles.ps1') -Raw
$subtitleCommonText = Get-Content -LiteralPath (Join-Path $root 'Modules\Subtitles.Common.ps1') -Raw
$subtitleSrtText = Get-Content -LiteralPath (Join-Path $root 'Modules\Subtitles.Srt.ps1') -Raw
$subtitleAssModuleText = Get-Content -LiteralPath (Join-Path $root 'Modules\Subtitles.Ass.ps1') -Raw
$subtitleTx3gText = Get-Content -LiteralPath (Join-Path $root 'Modules\Subtitles.Tx3g.ps1') -Raw
$subtitleBdpgsText = Get-Content -LiteralPath (Join-Path $root 'Modules\Subtitles.Bdpgs.ps1') -Raw
$subtitleBuildersText = Get-Content -LiteralPath (Join-Path $root 'Modules\Subtitles.Builders.ps1') -Raw
$pendingManifestStoreText = Get-Content -LiteralPath (Join-Path $root 'Modules\PendingManifestStore.ps1') -Raw
$pendingTransactionsText = Get-Content -LiteralPath (Join-Path $root 'Modules\PendingTransactions.ps1') -Raw
$pendingPublishIndexText = Get-Content -LiteralPath (Join-Path $root 'Modules\PendingPublishIndex.ps1') -Raw
$pendingPushText = Get-Content -LiteralPath (Join-Path $root 'Modules\PendingPush.ps1') -Raw
$publishCompletionText = Get-Content -LiteralPath (Join-Path $root 'Modules\PublishCompletion.ps1') -Raw
$sidecarText = Get-Content -LiteralPath (Join-Path $root 'Modules\Sidecar.ps1') -Raw
$pathHelpersText = Get-Content -LiteralPath (Join-Path $root 'Modules\PathHelpers.ps1') -Raw
$diskText = Get-Content -LiteralPath (Join-Path $root 'Modules\Disk.ps1') -Raw
$mediaProbeText = Get-Content -LiteralPath (Join-Path $root 'Modules\MediaProbe.ps1') -Raw
$folderPolicyText = Get-Content -LiteralPath (Join-Path $root 'Modules\FolderPolicy.ps1') -Raw
$audioText = Get-Content -LiteralPath (Join-Path $root 'Modules\Audio.ps1') -Raw
$nativeProcessContractsText = Get-Content -LiteralPath (Join-Path $root 'Modules\NativeProcessContracts.ps1') -Raw
$nativeText = Get-Content -LiteralPath (Join-Path $root 'Modules\Native.ps1') -Raw
$ffmpegProgressText = Get-Content -LiteralPath (Join-Path $root 'Modules\FfmpegProgress.ps1') -Raw
$failureCodesText = Get-Content -LiteralPath (Join-Path $root 'Modules\FailureCodes.ps1') -Raw
$failureStateText = Get-Content -LiteralPath (Join-Path $root 'Modules\FailureState.ps1') -Raw
$routingText = Get-Content -LiteralPath (Join-Path $root 'Modules\Routing.ps1') -Raw
$encodePolicyText = Get-Content -LiteralPath (Join-Path $root 'Modules\EncodePolicy.ps1') -Raw
$mediaConstantsText = Get-Content -LiteralPath (Join-Path $root 'Modules\MediaConstants.ps1') -Raw
$pipelineEngineText = Get-Content -LiteralPath (Join-Path $root 'Modules\PipelineEngine.ps1') -Raw
$pipelineProcessingText = Get-Content -LiteralPath (Join-Path $root 'Modules\PipelineProcessing.ps1') -Raw
$outputPathPlanningText = Get-Content -LiteralPath (Join-Path $root 'Modules\OutputPathPlanning.ps1') -Raw
$queuePlanText = Get-Content -LiteralPath (Join-Path $root 'Modules\QueuePlan.ps1') -Raw
$configSchemaModuleText = Get-Content -LiteralPath (Join-Path $root 'Modules\ConfigSchema.ps1') -Raw
$stateStoreText = Get-Content -LiteralPath (Join-Path $root 'Modules\StateStore.ps1') -Raw
$progressStateText = Get-Content -LiteralPath (Join-Path $root 'Modules\ProgressState.ps1') -Raw
$libraryIndexText = Get-Content -LiteralPath (Join-Path $root 'Modules\LibraryIndex.ps1') -Raw
...
Assert-True ($servicePathsText -match 'service_path_host_runner' -and $servicePathsText -match 'resolve_powershell_host_for_service' -and $servicePathsText -match 'which_func=shutil\.which' -and $servicePathsText -match 'subprocess_kwargs_hidden' -and $servicePathHostRunnerText -match 'def resolve_powershell_host_for_service' -and $servicePathHostRunnerText -match 'PowerShell-7\.6\.0-win-x64' -and $servicePathHostRunnerText -match 'def subprocess_kwargs_hidden' -and $servicePathHostRunnerText -match 'CREATE_NO_WINDOW') "PowerShell host discovery and hidden-window subprocess kwargs must live in a focused path-host runner while preserving service_paths shutil.which compatibility injection."
Assert-True ($servicePathsText -match 'service_path_defaults' -and $servicePathsText -match 'default_pipeline_path_for_roots' -and $servicePathsText -match 'default_config_path_for_roots' -and $servicePathsText -match 'default_audit_script_path_for_roots' -and $servicePathsText -match 'default_rerun_script_path_for_roots' -and $servicePathDefaultsText -match 'def default_pipeline_path_for_roots' -and $servicePathDefaultsText -match 'MediaPipeline_chatgpt\.ps1' -and $servicePathDefaultsText -match 'MediaPipeline_config_chatgpt\.psd1' -and $servicePathDefaultsText -match 'Audit-MediaLibrary_chatgpt\.ps1' -and $servicePathDefaultsText -match 'Invoke-RerunCsv\.ps1') "Desktop default pipeline/config/audit/rerun path candidate selection must live in a focused path-defaults helper behind PathResolutionService compatibility wrappers."
Assert-True ($servicePathsText -match 'service_path_layout' -and $servicePathsText -match 'first_existing' -and $servicePathsText -match 'path_within_root' -and $servicePathLayoutText -match 'def first_existing' -and $servicePathLayoutText -match 'def state_root_for_local_base' -and $servicePathLayoutText -match 'def valid_extensions_from_config' -and $servicePathLayoutText -match 'def normalized_path_key' -and $servicePathLayoutText -match 'def path_within_root') "Desktop pure path selection, extension defaults, normalized path keys, and root-containment helpers must live in a focused path-layout helper behind PathResolutionService compatibility wrappers."
Assert-True ($servicePathsText -match 'service_path_state_migration' -and ($servicePathsText + $servicePathResolutionRunnerText) -match 'app_state_path_for_state_root' -and $servicePathsText -match 'migrate_app_state_path_for_service' -and $servicePathStateMigrationText -match 'def app_state_path_for_state_root' -and $servicePathStateMigrationText -match 'def migrate_app_state_path' -and $servicePathStateMigrationText -match 'shutil\.copy2' -and $servicePathStateMigrationText -match 'App state migration failed') "Desktop app-state migration from legacy app root into LocalBase\\State\\App must live in a focused path-state helper behind PathResolutionService compatibility wrappers."
Assert-True ($servicePathsText -match 'service_path_resolution_runner' -and $servicePathsText -match 'resolve_paths_for_service' -and $servicePathResolutionRunnerText -match 'def resolve_paths_for_service' -and $servicePathResolutionRunnerText -match 'load_config_data' -and $servicePathResolutionRunnerText -match 'active_jobs_path = resolved\.state_root / "ActiveJobs"' -and $servicePathResolutionRunnerText -match 'queue_snapshot_path = service\._first_existing' -and $servicePathResolutionRunnerText -match 'completed_manifest_path = service\._first_existing' -and $servicePathResolutionRunnerText -match 'KEY_PRIORITY_MARKERS|PriorityMarkers') "Desktop path-resolution orchestration and versioned LocalBase state path assembly must live in a focused runner behind PathResolutionService compatibility wrappers."
...
Assert-True ($serviceProcessesText -match 'service_process_launch_runner' -and $serviceProcessesText -match 'start_pipeline_for_service' -and $serviceProcessesText -match 'start_audit_for_service' -and $serviceProcessesText -match 'start_rerun_csv_for_service' -and $serviceProcessLaunchRunnerText -match 'def start_pipeline_for_service' -and $serviceProcessLaunchRunnerText -match 'def start_audit_for_service' -and $serviceProcessLaunchRunnerText -match 'def start_rerun_csv_for_service' -and $serviceProcessLaunchRunnerText -match 'build_pipeline_launch_plan' -and $serviceProcessLaunchRunnerText -match 'service\._spawn') "Desktop process launch start-method orchestration must live in a focused runner behind ProcessLifecycleService compatibility wrappers."
Assert-True (($servicesText + $serviceReleaseText) -match 'def build_release_package' -and ($servicesText + $serviceReleaseText + $serviceReleasePlanText) -match 'Build-MediaPipelineRemuxEncodeAIO-Release\.ps1' -and ($servicesText + $servicePendingPublishText) -match 'def scan_pending_publish' -and ($appText + $appShellViewText) -match 'MaintenanceView' -and ($appText + $releaseControllerText) -match 'self\.service\.build_release_package|app\.service\.build_release_package' -and ($appText + $pendingPublishControllerText) -match 'self\.service\.scan_pending_publish|app\.service\.scan_pending_publish' -and $maintenanceViewText -match 'Release Package' -and $maintenanceViewText -match 'Pending Publish') "Desktop maintenance tools must expose release packaging and pending publish inventory through service-owned backends."
Assert-True ($serviceReleaseText -match 'service_release_plan' -and $serviceReleaseText -match 'build_release_command_args' -and $serviceReleasePlanText -match 'def build_release_command_args' -and $serviceReleasePlanText -match 'def release_artifact_paths' -and $serviceReleasePlanText -match 'KeepPersonalConfig') "Release package argument planning and artifact-path policy must live in a focused helper while the service keeps subprocess execution and manifest reads."
Assert-True ($serviceReleaseText -match 'service_release_result' -and $serviceReleaseText -match 'release_result_payload' -and $serviceReleaseResultText -match 'def release_capture_fields' -and $serviceReleaseResultText -match 'def release_result_payload' -and $serviceReleaseResultText -match 'kill_message' -and $serviceReleaseResultText -match 'manifest_exists') "Release package subprocess result normalization and operator payload shaping must live in a focused helper while the service keeps manifest file IO."
...
Assert-True ($serviceStatusPresentationText -match 'service_status_events' -and $serviceStatusEventsText -match 'def format_pipeline_event_summary' -and $serviceStatusEventsText -match 'def structured_status_from_pipeline_event' -and $serviceStatusEventsText -match 'def pipeline_event_stage_label' -and $serviceStatusEventsText -match 'priority_requested') "Pipeline-event status labels and diagnostic summary rows must live in a focused status-events helper behind the status presentation compatibility exports."
Assert-True ($serviceAuditRerunText -match 'service_audit_rerun_records' -and $serviceAuditRerunText -match 'def correlate_audit_record' -and $serviceAuditRerunText -match 'correlate_audit_record_helper' -and $serviceAuditRerunRecordsText -match 'def audit_correlation_lookup_key' -and $serviceAuditRerunRecordsText -match 'def correlate_audit_record' -and $serviceAuditRerunRecordsText -match 'def rerun_media_kind_from_audit') "Audit rerun correlation and media-kind policy must live in a focused helper behind AuditRerunService compatibility wrappers."
Assert-True ($serviceAuditRerunExportText -match 'service_audit_rerun_csv' -and $serviceAuditRerunExportText -match 'build_rerun_csv_row' -and $serviceAuditRerunExportText -match 'source_stat_to_rerun_values' -and $serviceAuditRerunCsvText -match 'def build_rerun_csv_row' -and $serviceAuditRerunCsvText -match 'def apply_rerun_source_metadata' -and $serviceAuditRerunCsvText -match 'def source_stat_to_rerun_values') "Audit rerun CSV row policy must live in a focused helper behind the rerun export runner."
Assert-True ($serviceAuditRerunText -match 'service_audit_rerun_export' -and $serviceAuditRerunText -match 'save_rerun_records_csv_for_service' -and $serviceAuditRerunExportText -match 'def save_rerun_records_csv_for_service' -and $serviceAuditRerunExportText -match 'stage_mode = "copy"' -and $serviceAuditRerunExportText -match 'original_mode = "keep"' -and $serviceAuditRerunExportText -match 'return_mode = "park"' -and $serviceAuditRerunExportText -match '_atomic_write_text') "Audit rerun CSV export orchestration, safe default modes, source-stat fallback, and atomic write must live in a focused export runner behind AuditRerunService compatibility wrappers."
Assert-True ($serviceAuditRerunText -match 'service_audit_rerun_metadata' -and $serviceAuditRerunText -match 'load_rerun_source_metadata_for_service' -and $serviceAuditRerunMetadataText -match 'def rerun_source_metadata_script_path_for_service' -and $serviceAuditRerunMetadataText -match 'def deduplicate_source_paths' -and $serviceAuditRerunMetadataText -match 'def load_rerun_source_metadata_for_service' -and $serviceAuditRerunMetadataText -match 'TemporaryDirectory' -and $serviceAuditRerunMetadataText -match 'run_capture_func' -and $serviceAuditRerunMetadataText -match 'Rerun source metadata helper timed out') "Audit rerun source-metadata helper script selection, temp JSON exchange, subprocess execution, timeout handling, and result indexing must live in a focused metadata helper behind AuditRerunService compatibility wrappers."
Assert-True ($serviceAuditRerunText -match 'service_audit_rerun_io' -and $serviceAuditRerunIoText -match 'def load_audit_records' -and $serviceAuditRerunIoText -match 'def save_audit_records_csv' -and $serviceAuditRerunIoText -match 'def load_failure_records' -and $serviceAuditRerunIoText -match 'def load_failure_marker_records') "Audit/rerun CSV and failure JSON file IO must live in a focused helper behind AuditRerunService compatibility wrappers."
Assert-True (($serviceAuditRerunText + $serviceAuditRerunIoText) -match 'service_failure_markers' -and ($serviceAuditRerunText + $serviceAuditRerunIoText) -match 'failure_record_from_marker_payload' -and $serviceFailureMarkersText -match 'FAILURE_MARKER_KEY_MAP' -and $serviceFailureMarkersText -match 'def normalize_failure_marker_payload' -and $serviceFailureMarkersText -match 'def failure_record_from_marker_payload') "Failure marker payload normalization must live in a focused helper while marker-store scanning uses that shared normalization path."
Assert-True ($servicePendingPublishText -match 'service_pending_publish_format' -and $servicePendingPublishText -match 'format_bytes_compact' -and $servicePendingPublishText -match 'parse_pending_datetime' -and $servicePendingPublishFormatText -match 'def format_bytes_compact' -and $servicePendingPublishFormatText -match 'def format_pending_datetime_text' -and $servicePendingPublishFormatText -match 'def pending_age_text') "Pending publish presentation formatting must live in a focused helper while the service keeps manifest scanning and row construction."
Assert-True ($servicePendingPublishText -match 'service_pending_publish_manifest' -and $servicePendingPublishText -match 'pending_manifest_row' -and $servicePendingPublishManifestText -match 'def pending_manifest_row' -and $servicePendingPublishManifestText -match 'service_pending_publish_manifest_rows' -and $servicePendingPublishManifestText -match 'PendingPushManifest\.from_mapping' -and ($servicePendingPublishManifestText + $servicePendingPublishManifestRowsText) -match 'invalid_contract' -and $servicePendingPublishManifestRowsText -match 'Manifest local_file payload is missing') "Pending publish manifest contract parsing and health-row shaping must live in a focused helper while the service keeps directory scanning and aggregate counts."
...
Assert-True ($serviceProcessesText -match 'service_process_control_runner' -and $serviceProcessesText -match 'prepare_pipeline_control_flags_for_service' -and $serviceProcessesText -match 'toggle_pause_flag_for_service' -and $serviceProcessesText -match 'write_flag_for_service' -and $serviceProcessControlRunnerText -match 'def prepare_pipeline_control_flags_for_service' -and $serviceProcessControlRunnerText -match 'prepare_control_flags_for_launch_helper' -and $serviceProcessControlRunnerText -match 'def toggle_pause_flag_for_service' -and $serviceProcessControlRunnerText -match 'def write_flag_for_service' -and $serviceProcessControlRunnerText -match 'read_control_flag_payload\(flag_path, logger=service\.logger\)') "Desktop pause/stop/rescan service orchestration must live in a focused control runner behind ProcessLifecycleService compatibility wrappers."
Assert-True (($controlFlagServiceText + $runtimeArtifactServiceText) -match 'service_process_launch_cleanup' -and $serviceProcessLaunchCleanupText -match 'def prepare_stale_progress_cleanup' -and $serviceProcessLaunchCleanupText -match 'Stale \{progress_label\} progress was not cleared' -and $serviceProcessLaunchCleanupText -match 'Cleared stale \{progress_label\} progress before launch') "Desktop launch-time stale progress and control-flag cleanup policy must live in a focused helper while process service keeps process ownership."
...
Assert-True ($serviceConfigText -match 'service_config_document_runner' -and $serviceConfigText -match 'load_config_data_for_service' -and $serviceConfigText -match 'validate_config_document_for_save_for_service' -and $serviceConfigText -match 'run_capture' -and $serviceConfigDocumentRunnerText -match 'def load_config_data_for_service' -and $serviceConfigDocumentRunnerText -match 'label="config import"' -and $serviceConfigDocumentRunnerText -match 'def validate_config_document_for_save_for_service' -and $serviceConfigDocumentRunnerText -match 'config syntax validation' -and $serviceConfigDocumentRunnerText -match 'Import-PowerShellDataFile') "Desktop config document import and PSD1 syntax validation subprocess orchestration must live in a focused runner while preserving the service run_capture compatibility patch point."
Assert-True ($serviceConfigText -match 'service_config_save_runner' -and $serviceConfigText -match 'save_config_document_for_service' -and $serviceConfigText -match 'save_config_profile_for_service' -and $serviceConfigText -match 'load_config_profile_for_service' -and $serviceConfigSaveRunnerText -match 'def save_config_document_for_service' -and $serviceConfigSaveRunnerText -match 'def list_config_profiles_for_service' -and $serviceConfigSaveRunnerText -match 'def save_config_profile_for_service' -and $serviceConfigSaveRunnerText -match 'def load_config_profile_for_service' -and $serviceConfigSaveRunnerText -match '_atomic_write_text') "Desktop config document save, profile listing, path normalization, and profile save/load file I/O must live in a focused runner behind ConfigProfileService compatibility wrappers."
Assert-True ($serviceConfigText -match 'service_config_preview' -and $serviceConfigText -match 'build_config_preview_helper' -and $serviceConfigPreviewText -match 'def build_config_preview' -and $serviceConfigPreviewText -match 'ExtraVideoFlags' -and $serviceConfigPreviewText -match 'AudioPassthroughProfile' -and $serviceConfigPreviewText -match 'CompatibleAudioCodecs') "Desktop config preview merge, encoder tuning, and audio-profile codec policy must live in a focused helper behind config service compatibility wrappers."
Assert-True ($serviceConfigText -match 'service_config_validation' -and $serviceConfigText -match 'def validate_config_values' -and $serviceConfigText -match 'def _config_path_overlap_warning' -and $serviceConfigValidationText -match 'def validate_config_values' -and $serviceConfigValidationText -match 'def config_path_overlap_warning' -and $serviceConfigOptionPolicyText -match 'AudioTranscodeBitrate must look like 640k') "Desktop config value validation and root-overlap warnings must live in focused helpers behind ConfigProfileService compatibility wrappers."
Assert-True ($serviceConfigValidationText -match 'service_config_numeric_policy' -and $serviceConfigValidationText -match 'validate_required_and_numeric_config' -and $serviceConfigNumericPolicyText -match 'def validate_required_and_numeric_config' -and $serviceConfigNumericPolicyText -match 'IndexScanTimeoutSeconds' -and $serviceConfigNumericPolicyText -match 'TransientFailureRetryLimit') "Desktop required-field and numeric config bounds must live in a focused policy helper behind config validation."
Assert-True ($serviceConfigValidationText -match 'service_config_option_policy' -and $serviceConfigValidationText -match 'validate_option_config' -and $serviceConfigOptionPolicyText -match 'def validate_option_config' -and $serviceConfigOptionPolicyText -match 'EncodeTuningPreset must be one of' -and $serviceConfigOptionPolicyText -match 'CompatibleAudioCodecs are controlled by AudioPassthroughProfile') "Desktop config enum, structured encoding, audio, log-level, and required-list policy must live in a focused option helper behind config validation."
Assert-True ($serviceConfigValidationText -match 'service_config_path_warnings' -and $serviceConfigValidationText -match 'config_root_path_warnings' -and $serviceConfigPathWarningsText -match 'def config_path_overlap_warning' -and $serviceConfigPathWarningsText -match 'def config_root_path_warnings' -and $serviceConfigPathWarningsText -match 'LocalBase and Outsource are identical') "Desktop config root path overlap warning policy must live in a focused helper behind config validation compatibility wrappers."
Assert-True ($serviceConfigNumericPolicyText -match 'service_config_value_checks' -and $serviceConfigNumericPolicyText -match 'validate_optional_float' -and $serviceConfigValueChecksText -match 'def require_non_empty' -and $serviceConfigValueChecksText -match 'def validate_int' -and $serviceConfigValueChecksText -match 'def add_unique_warning') "Desktop primitive config value checks must live in focused helpers behind the config validation policy."
...
Assert-True (
    ...
    $deployabilityChecklistText -match 'Build-MediaPipelineRemuxEncodeAIO-Release\.ps1'
...
Assert-True (
    ...
    $releaseBuilderText -match 'Test-MediaPipelineRemuxEncodeAIO-Release\.ps1'
...
Assert-True ($serviceRenameText -match 'service_rename_preview' -and $serviceRenameText -match 'load_pipeline_name_previews' -and $serviceRenamePreviewText -match 'def load_pipeline_name_previews' -and $serviceRenamePreviewText -match 'def parse_naming_preview_rows' -and $serviceRenamePreviewText -match 'naming_preview_request\.v1') "Rename pipeline naming-preview script discovery, subprocess execution, and output parsing must live in a focused helper behind RenameService compatibility wrappers."
Assert-True ($serviceRenameText -match 'service_rename_preview_runner' -and $serviceRenameText -match 'load_pipeline_name_previews_for_service' -and $serviceRenameText -match 'run_capture' -and $serviceRenamePreviewRunnerText -match 'def naming_preview_script_path_for_service' -and $serviceRenamePreviewRunnerText -match 'def load_pipeline_name_previews_for_service' -and $serviceRenamePreviewRunnerText -match '_subprocess_kwargs_hidden' -and $serviceRenamePreviewRunnerText -match 'run_capture_func=run_capture_func') "Rename pipeline naming-preview service orchestration must live in a focused runner while preserving the service run_capture compatibility patch point."
Assert-True ($serviceRenameText -match 'service_rename_discovery' -and $serviceRenameText -match 'discover_rename_media_files_helper' -and $serviceRenameDiscoveryText -match 'def discover_rename_media_files' -and $serviceRenameDiscoveryText -match 'MEDIA_FILE_SUFFIXES' -and $serviceRenameDiscoveryText -match 'natural_sort_key') "Standalone rename media discovery must live in a focused helper behind RenameService compatibility wrappers."
Assert-True ($serviceRenameText -match 'service_rename_plan_policy' -and ($serviceRenameText + $serviceRenamePlannerText) -match 'rename_row_status' -and $serviceRenamePlanPolicyText -match 'def rename_row_status' -and $serviceRenamePlanPolicyText -match 'return "match"' -and $serviceRenamePlanPolicyText -match 'def normalise_manual_final_name' -and $serviceRenamePlanPolicyText -match 'def build_movie_rename_name') "Standalone rename manual override, movie target, and row status policy must live in a focused helper behind RenameService compatibility wrappers."
Assert-True ($serviceRenameText -match 'service_rename_planner' -and $serviceRenameText -match 'plan_rename_paths_for_service' -and $serviceRenamePlannerText -match 'def plan_rename_paths_for_service' -and $serviceRenamePlannerText -match 'MEDIA_FILE_SUFFIXES' -and $serviceRenamePlannerText -match 'VLC_LONG_PATH_THRESHOLD' -and $serviceRenamePlannerText -match 'rename_row_status') "Standalone rename TV/movie preview planning must live in a focused planner helper behind RenameService compatibility wrappers."
Assert-True ($serviceRenameText -match 'resolve_tv_folder_season_info' -and $serviceRenameTvText -match 'service_rename_tv_folder' -and $serviceRenameTvText -match 'resolve_tv_folder_season_info_with_cleaner' -and $serviceRenameTvFolderText -match 'def resolve_tv_folder_season_info' -and $serviceRenameTvFolderText -match 'TV_SPECIALS_FOLDER_PATTERN' -and $serviceRenameTvFolderText -match 'TV_ORDINAL_WORDS' -and $serviceRenameTvFolderText -match 'specials-folder' -and $serviceRenameTvFolderText -match 'show-season-folder') "Standalone TV rename folder season/specials inference must live in a focused helper while service_rename_tv preserves its public function and constants."
...
Assert-True ($serviceProcessesText -match 'service_process_spawn_runner' -and $serviceProcessesText -match 'spawn_process_for_service' -and $serviceProcessSpawnRunnerText -match 'def spawn_process_for_service' -and $serviceProcessSpawnRunnerText -match 'subprocess\.Popen' -and $serviceProcessSpawnRunnerText -match '_write_active_job_launch_record' -and $serviceProcessSpawnRunnerText -match '_verify_spawn_readiness') "Desktop process spawn orchestration must live in a focused runner behind ProcessLifecycleService compatibility wrappers."
...
Assert-True ($serviceProcessesText -match 'service_process_runtime_runner' -and $serviceProcessesText -match 'prepare_pipeline_runtime_for_service' -and $serviceProcessesText -match 'prepare_audit_runtime_for_service' -and $serviceProcessRuntimeRunnerText -match 'def prepare_pipeline_runtime_for_service' -and $serviceProcessRuntimeRunnerText -match 'clear_pipeline_progress_artifacts_for_service' -and $serviceProcessRuntimeRunnerText -match 'def prepare_audit_runtime_for_service' -and $serviceProcessRuntimeRunnerText -match 'clear_audit_progress_artifacts_for_service' -and $serviceProcessRuntimeRunnerText -match 'prepare_stale_progress_cleanup') "Desktop pipeline/audit runtime cleanup orchestration must live in a focused runtime runner behind ProcessLifecycleService compatibility wrappers."
...
try {
    ...
    `$mutex = [System.Threading.Mutex]::new(`$false, "Global\MediaPipelineSingleInstance_v781_`$suffix")
...
from mediapipeline_desktop_app.services import APP_STATE_NAME, DesktopAppService, _normalize_open_path_text, _strip_windows_extended_path_prefix
from mediapipeline_desktop_app.models import AuditRecord, CompletedJobRecord, FailureRecord, ResolvedPaths
from mediapipeline_desktop_app.priority_markers import remove_priority_markers_from_name, starts_with_priority_marker
from mediapipeline_desktop_app.workers import UiBackgroundWorker
