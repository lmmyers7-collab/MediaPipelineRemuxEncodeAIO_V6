...
$publishPartialModule = Join-Path $repoRoot 'engine\publish\publish_partial.ps1'
$publishSidecarsModule = Join-Path $repoRoot 'engine\publish\publish_sidecars.ps1'
$srtModule = Join-Path $repoRoot 'engine\subtitles\srt.ps1'
