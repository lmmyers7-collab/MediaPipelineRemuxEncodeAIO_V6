...
$appStateMigrationPath = Join-Path $desktopRoot 'mediapipeline_desktop_app\service_path_state_migration.py'
$pathResolutionRunnerPath = Join-Path $desktopRoot 'mediapipeline_desktop_app\service_path_resolution_runner.py'
...
Assert-True (Test-Path -LiteralPath $appStateMigrationPath -PathType Leaf) 'service_path_state_migration.py is missing.'
Assert-True (Test-Path -LiteralPath $pathResolutionRunnerPath -PathType Leaf) 'service_path_resolution_runner.py is missing.'
