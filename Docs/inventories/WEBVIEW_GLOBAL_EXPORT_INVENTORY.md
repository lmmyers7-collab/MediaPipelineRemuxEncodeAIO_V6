...
- **55 files** also export flat functions directly onto `window`
...
| `launchView.js` | mediaPipelineLaunchView | 78 | Generated from current `window.* =` assignments |
