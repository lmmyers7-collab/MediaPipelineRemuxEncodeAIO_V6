...
- **66 files** also export flat functions directly onto `window`
...
| `completedView.js` | mediaPipelineCompletedView | 133 | Generated from current `window.* =` assignments |
...
| `progressView.js` | mediaPipelineProgressView | 4 | Generated from current `window.* =` assignments |
