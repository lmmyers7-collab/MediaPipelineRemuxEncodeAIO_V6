...
- Python test definitions scanned: **2542**
- Duplicate bare names across files: **8**
...
| `tests/python/desktop/test_service_config_validation.py` | `ServiceConfigValidationTests.test_config_path_overlap_warning_reports_same_source_roots` | 335 |
...
### `test_mutation_capable_payloads_use_shared_intent_or_disabled_ingest_exception`

| File | Qualname | Line |
|---|---|---:|
| `tests/python/core/contract/test_stage_contracts.py` | `StageContractTests.test_mutation_capable_payloads_use_shared_intent_or_disabled_ingest_exception` | 116 |
| `tests/python/desktop/test_stage_contracts.py` | `StageContractTests.test_mutation_capable_payloads_use_shared_intent_or_disabled_ingest_exception` | 137 |

### `test_stage_request_rejects_payload_for_wrong_stage`

| File | Qualname | Line |
|---|---|---:|
| `tests/python/core/contract/test_stage_contracts.py` | `StageContractTests.test_stage_request_rejects_payload_for_wrong_stage` | 112 |
| `tests/python/desktop/test_stage_contracts.py` | `StageContractTests.test_stage_request_rejects_payload_for_wrong_stage` | 115 |
...
| `tests/python/desktop/test_facade_process_rerun_policy.py` | `RerunLaunchPolicyTests.test_success_message_and_payload_are_stable` | 51 |
