...
- **Payload fields:** `file_size_bytes`, `is_tv`, `duration_seconds`, `video_codec`, `video_height`, `is_hdr`, `routing_profile`, `size_guard_mode`, `encode_threshold_gb`, `tv_encode_threshold_gb`, `movie_route_max_video_bitrate_mbps`, `tv_route_max_video_bitrate_mbps`, `allow_h264_remux_if_plex_compatible`, `h264_remux_max_bitrate_mbps`, `h264_remux_max_height`, `route_hints`, `source_media_profile`
