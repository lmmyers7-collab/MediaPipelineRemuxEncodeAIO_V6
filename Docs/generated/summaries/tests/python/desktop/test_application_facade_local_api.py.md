...
sha256: b35c23647b2500ff35c16037a1d312773104bca6a3e6d81adde85b5857fff7cf
---
# `tests/python/desktop/test_application_facade_local_api.py`

**Purpose:** (no module docstring)

**Classes:** `LocalApiServerTests`
...
_Edit the source, not this file. Regenerate with `apps/desktop/runtime/Python/python.exe ops/scripts/dev/run-python-tool.py mediapipeline.tools.dev.refresh_summaries --paths tests/python/desktop/test_application_facade_local_api.py`._
