...
**Functions:** `Get-MediaRouteHeightToleranceBoundaries`, `Get-MediaRouteMaxHeightFromUpperTolerance`, `Get-MediaRouteMinHeightFromLowerTolerance`, `Resolve-MediaRouteResolutionBitrateSelection`, `Resolve-MediaRouteResolutionSizeSelection`, `Test-MediaEncodeOutputSizePolicy`
