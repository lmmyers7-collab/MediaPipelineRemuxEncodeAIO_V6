...
**Functions:** `Assert-Equal`, `Assert-True`, `DebugLog`, `Format-NativeCommandLine`, `Invoke-FFprobeCommand`, `Invoke-NativeProcess`, `Save-ReproCommand`, `Set-ProgressStage`, `Write-Log`, `Write-PipelineEvent`
