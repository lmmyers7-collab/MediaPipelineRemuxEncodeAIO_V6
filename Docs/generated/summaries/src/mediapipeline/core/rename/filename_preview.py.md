...
sha256: 22fa1f8565b3317f51c328782b144d9ef13663de04ffa839368fa97b72f8e9d9
---
# `src/mediapipeline/core/rename/filename_preview.py`

**Purpose:** Read-only rename filename preview and filter catalog payloads.

**Public functions:** `rename_clean_filename_preview_from_request()`, `rename_filename_leaf()`, `rename_movie_filter_catalog_payload()`, `rename_plan_kwargs_from_request()`
**In-repo imports:** `mediapipeline.core.files.constants`, `mediapipeline.core.rename.cleaning_policy`, `mediapipeline.core.rename.movie`
