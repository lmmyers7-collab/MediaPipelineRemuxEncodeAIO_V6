...
- [ ] **Encoder breadth and AV1** — Config/schema choices include AV1/QSV/AMF/libaom families, and Phase 0 encode-argument snapshots plus the Phase 1 HEVC/NVENC/libx265 descriptor parity scaffold are in place. New encoder families still need descriptor-backed flag generation, capability probing, fallback behavior, and real-media validation before they are considered daily-driver safe.
