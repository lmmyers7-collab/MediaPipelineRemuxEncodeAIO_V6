...
FRIENDLY_LABEL_PERSISTED_KEY_ALIASES: dict[str, str] = {
    ...
    "Movie fallback max bitrate": "MovieRouteMaxVideoBitrateMbps",
    "TVMaxBitrateForDirectCopy": "TVRouteMaxVideoBitrateMbps",
    "TV max bitrate for direct copy": "TVRouteMaxVideoBitrateMbps",
    "TV fallback max bitrate": "TVRouteMaxVideoBitrateMbps",
    "1080ishDirectCopyBucketMaxHeight": "Route1080pBucketMaxHeight",
    "1080-ish direct-copy bucket max height": "Route1080pBucketMaxHeight",
    ...
    "4KDirectCopyBucketMinHeight": "Route4KBucketMinHeight",
    "4K direct-copy bucket min height": "Route4KBucketMinHeight",
