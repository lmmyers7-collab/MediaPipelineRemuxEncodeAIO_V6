...
from app.config.identity import (
...
def _canonical_candidates(app_root: Path, workspace_root: Path) -> list[Path]:
    # Same order/locations as app.paths.defaults.default_config_path_for_roots.
    return [
        workspace_root / "Pipeline" / CANONICAL_CONFIG_NAME,
        app_root / "Pipeline" / CANONICAL_CONFIG_NAME,
        workspace_root / CANONICAL_CONFIG_NAME,
        app_root / CANONICAL_CONFIG_NAME,
    ]


def _legacy_candidates(app_root: Path, workspace_root: Path) -> list[Path]:
    return [
        workspace_root / "Pipeline" / LEGACY_CONFIG_NAME,
        app_root / "Pipeline" / LEGACY_CONFIG_NAME,
        workspace_root / LEGACY_CONFIG_NAME,
        app_root / LEGACY_CONFIG_NAME,
    ]
