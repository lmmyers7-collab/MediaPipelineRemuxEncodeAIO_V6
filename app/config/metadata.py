"""Desktop settings metadata derived from the canonical config contract.

`app.contracts.config.Config` owns the value schema. This module owns the
operator-facing labels, choices, grouping, and WebView metadata needed to
render the current settings UI without depending on the deprecated
Desktop config metadata shims.
"""
...
from .metadata_network import NETWORK_CONFIG_DEFAULTS, NETWORK_ROLE_CHOICES
...
CONFIG_FIELD_DEFINITIONS = (
    ...
    },
    {
        ...
        "label": "Movie Copy Max Mbps",
        "kind": "int",
        "default": 35,
        "help": "Maximum estimated source bitrate for movie remux/copy routing before encode is selected.",
    },
    {
        "page": "Basic",
        "section": "Routing",
        "key": "TVRouteMaxVideoBitrateMbps",
        "label": "TV Copy Max Mbps",
        "kind": "int",
        "default": 18,
        "help": "Maximum estimated source bitrate for TV remux/copy routing before encode is selected.",
    },
    {
        "page": "Basic",
        "section": "Routing",
