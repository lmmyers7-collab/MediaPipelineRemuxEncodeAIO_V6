...
BASIC_CONFIG_FIELD_DEFINITIONS = (
    ...
    },
    {
        ...
        "kind": "int",
        "default": 35,
        "help": "Fallback movie bitrate cap in Mbps when source height is unknown. Known-height sources use the 1080-ish or 4K bucket cap instead.",
    },
    {
        "page": "Basic",
        "section": "Routing",
        ...
        "kind": "int",
        "default": 18,
        "help": "Fallback TV bitrate cap in Mbps when source height is unknown. Known-height sources use the 1080-ish or 4K bucket cap instead.",
    },
    {
        "page": "Basic",
        "section": "Routing",
        "key": "Route1080pBucketMaxHeight",
        "label": "1080-ish max height",
        "kind": "int",
        "default": 1200,
        "help": "Sources at or below this height use the 1080-ish bitrate cap. Height only selects the bitrate threshold; it does not force remux or encode.",
    },
    {
        "page": "Basic",
        "section": "Routing",
        "key": "Route1080pMaxVideoBitrateMbps",
        "label": "1080-ish max bitrate",
        "kind": "int",
        "default": 20,
        "help": "Direct-copy/remux bitrate cap in Mbps for sources in the 1080-ish height bucket.",
    },
    {
        "page": "Basic",
        "section": "Routing",
        ...
        "kind": "int",
        "default": 1800,
        "help": "Sources at or above this height use the 4K bitrate cap. Heights between the 1080-ish max and this value also use the 4K cap by default.",
    },
    {
        "page": "Basic",
        "section": "Routing",
        ...
        "kind": "int",
        "default": 35,
        "help": "Direct-copy/remux bitrate cap in Mbps for 4K and in-between source heights.",
    },
    {
        "page": "Basic",
        "section": "Routing",
