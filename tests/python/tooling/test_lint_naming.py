...
MODULE_PATH = REPO_ROOT / "src" / "mediapipeline" / "tools" / "lint_naming.py"
...
class NamingLintTests(unittest.TestCase):
        ...
        self.assertEqual(
            lint_naming.findings_for_paths(
                [
                    ...
                    "src/mediapipeline/core/settings/profile.py",
        ...
        self.assertEqual(
            _rule_ids(
                [
                    ...
                    "src/mediapipeline/core/config/load_old.py",
                    "ops/pipeline/engine/probe/runner_new.ps1",
                ]
            ),
            {"NAME007"},
        )
    ...
    def test_root_status_docs_and_callers_are_blocked(self) -> None:
        ...
        self.assertEqual(lint_naming.findings_for_paths(["docs/OPEN_WORK_CHECKLIST.md"]), [])
        self.assertEqual(
