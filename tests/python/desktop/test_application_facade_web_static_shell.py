...
ASSET_ORDER_PAIRS = [
    ...
    ("/assets/commandHistory/diagnostics.js", "/assets/commandHistory.js"),
    ...
    ("/assets/completed/evidence/routeAgreement.js", "/assets/completedView.evidence.js"),
    ("/assets/completedView.evidence.js", "/assets/completedView.proof.js"),
    ("/assets/completedView.proof.js", "/assets/completed/review/integrity.js"),
    ("/assets/completed/review/integrity.js", "/assets/completed/review/sizeReview.js"),
    ...
    ("/assets/completed/review/investigationFilters.js", "/assets/completedView.review.js"),
    ("/assets/completedView.review.js", "/assets/completedView.diagnostics.js"),
    ("/assets/completedView.diagnostics.js", "/assets/completedView.js"),
    ...
    ("/assets/queueView.launch.js", "/assets/queueView.js"),
    ...
    ("/assets/pendingPublishView.drain.js", "/assets/pendingPublishView.confidence.js"),
    ("/assets/pendingPublishView.confidence.js", "/assets/pendingPublishView.js"),
    ...
    ("/assets/renameHistoryView.js", "/assets/renameView.js"),
    ...
    ("/assets/settingsView.safetyLocks.js", "/assets/settingsView.js"),
    ...
    ("/assets/diagnosticsView.investigation.js", "/assets/diagnosticsView.js"),
    ("/assets/diagnosticsView.js", "/assets/reportsView.js"),
    ("/assets/reportsView.js", "/assets/scheduleView.js"),
    ("/assets/scheduleView.js", "/assets/maintenanceView.js"),
    ("/assets/maintenanceView.js", "/assets/telemetryView.js"),
    ...
    ("/assets/launchView.risk.js", "/assets/launchView.scope.js"),
    ("/assets/launchView.scope.js", "/assets/launchView.realmedia.js"),
    ("/assets/launchView.realmedia.js", "/assets/launchView.preflight.js"),
    ...
    ("/assets/launch/commandButtons.js", "/assets/launchView.js"),
...
class ApplicationFacadeWebStaticShellTests(unittest.TestCase):
    ...
    def test_common_app_shell_exports_are_static_pinned(self) -> None:
        ...
        self.assertIn("Request timed out after", bundle.api_client_js)
        self.assertIn("apiGet(path, options = {})", bundle.api_client_js)
        self.assertIn("apiPost(path, payload, options = {})", bundle.api_client_js)
        self.assertIn("timeoutValue(options.timeoutMs, DEFAULT_GET_TIMEOUT_MS)", bundle.api_client_js)
        self.assertIn("timeoutValue(options.timeoutMs, 0)", bundle.api_client_js)
        self.assertIn("const raw = await response.text()", bundle.api_client_js)
        self.assertIn("JSON.parse(raw)", bundle.api_client_js)
        self.assertIn('raw.trim().replace(/\\s+/g, " ").slice(0, 500)', bundle.api_client_js)
        self.assertIn("data.error || data.message || `HTTP ${response.status}`", bundle.api_client_js)
