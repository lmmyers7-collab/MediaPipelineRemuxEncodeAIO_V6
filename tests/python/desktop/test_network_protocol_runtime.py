...
class NetworkProtocolRuntimeTests(unittest.TestCase):
    ...
    def test_worker_claim_record_invalid_cluster_log_failure_still_releases_claim(self) -> None:
        ...
        with (
            patch("mediapipeline.desktop.network.worker_loops._make_queue_record", side_effect=RuntimeError("record invalid")),
    ...
    def test_worker_claim_record_invalid_diagnostic_is_bounded(self) -> None:
        ...
        with (
            patch("mediapipeline.desktop.network.worker_loops._make_queue_record", side_effect=RuntimeError(long_error)),
    ...
    def test_worker_poll_interval_coercion_handles_malformed_config(self) -> None:
        ...
        with self.assertLogs("mediapipeline.desktop.network.poll_policy", level="WARNING") as logs:
