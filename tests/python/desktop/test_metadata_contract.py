...
from mediapipeline.core.config.library_profiles import LIBRARY_OVERRIDE_GROUP_BY_KEY, LIBRARY_OVERRIDE_KEYS_BY_GROUP
...
LABEL_ONLY_RENAMES = {
    ...
    "RouteThresholdMode": ("What forces an encode?", "editor"),
    "SizeGuardMode": ("If encoded output is too large", "editor"),
    "EncodeTuningPreset": ("NVENC tuning bundle", "editor"),
...
REPRESENTATIVE_DISPLAY_TAXONOMY = {
    "RoutingProfile": (
        ...
        ("routing", "playback"),
        "hard",
        "Overall library intent. Controls the copy/remux-first policy before an encode is considered.",
    ),
    "RouteThresholdMode": (
        "Encode Trigger",
        "Routing",
