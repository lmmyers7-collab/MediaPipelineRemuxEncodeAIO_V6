...
class LocalApiServerTests(unittest.TestCase):
    ...
    def test_local_api_serves_read_only_web_prototype(self) -> None:
        ...
        self.assertIn('id="queue-detail" class="prose-block" data-visual-keep="copy-output"', html)
        ...
        self.assertIn('id="completed-detail" class="prose-block" data-visual-keep="copy-output"', html)
        ...
        self.assertIn('id="pending-detail" class="prose-block" data-visual-keep="copy-output"', html)
        ...
        _assert_namespace_export(self, command_history_js, "mediaPipelineCommandHistory", "commandHistoryRefreshTarget")
        _assert_namespace_export(self, command_history_js, "mediaPipelineCommandHistory", "commandHistoryDiagnosticsActions")
        ...
        self.assertNotIn("window.commandHistoryRefreshTarget = commandHistoryRefreshTarget", command_history_js)
        ...
        self.assertIn("completedView.getLastCompletedRows", command_history_js)
        self.assertNotIn("typeof getLastCompletedRows === \"function\"", command_history_js)
        ...
        self.assertIn("const completedView = window.mediaPipelineCompletedView || {}", command_history_js)
        self.assertIn("completedView.renderCompletedOpenHistory?.(commandHistory)", command_history_js)
        self.assertIn("renderPendingOpenHistory(commandHistory)", command_history_js)
        self.assertIn("function renderDiagnosticsOpenHistoryFromNamespace", command_history_js)
        self.assertIn("window.mediaPipelineDiagnosticsView?.renderDiagnosticsOpenHistory?.(history)", command_history_js)
        self.assertIn("renderDiagnosticsOpenHistoryFromNamespace(commandHistory)", command_history_js)
        ...
        self.assertNotIn("typeof renderDiagnosticsOpenHistory === \"function\"", command_history_js)
        self.assertIn("function renderLaunchPipelineControlHistory", command_history_js)
        self.assertIn("const launchView = window.mediaPipelineLaunchView || {}", command_history_js)
        self.assertIn("launchView.renderPipelineControlHistory(history)", command_history_js)
        self.assertIn("renderLaunchPipelineControlHistory(commandHistory)", command_history_js)
        self.assertNotIn("typeof renderPipelineControlHistory === \"function\"", command_history_js)
        ...
        self.assertNotIn("window.renderCompleted = renderCompleted", completed_view_js)
        self.assertIn("window.mediaPipelineCompletedView?.renderCompleted?.(values.completed)", js)
        self.assertIn("window.mediaPipelineCompletedView?.renderCompleted?.(completed)", app_refresh_js)
        self.assertNotIn("renderCompleted(values.completed)", js)
        self.assertNotIn("renderCompleted(completed)", app_refresh_js)
        ...
        self.assertIn("commandHistoryCommandText: window.mediaPipelineCommandHistory?.commandHistoryCommandText", completed_view_js)
        self.assertNotIn("commandHistoryCommandText: window.commandHistoryCommandText", completed_view_js)
        self.assertIn("commandHistoryIssueLevel: window.mediaPipelineCommandHistory?.commandHistoryIssueLevel", completed_view_js)
        self.assertNotIn("commandHistoryIssueLevel: window.commandHistoryIssueLevel", completed_view_js)
        self.assertIn("commandHistoryOwnerPage: window.mediaPipelineCommandHistory?.commandHistoryOwnerPage", completed_view_js)
        self.assertNotIn("commandHistoryOwnerPage: window.commandHistoryOwnerPage", completed_view_js)
        self.assertIn("commandHistorySuggestedAction: window.mediaPipelineCommandHistory?.commandHistorySuggestedAction", completed_view_js)
        self.assertNotIn("commandHistorySuggestedAction: window.commandHistorySuggestedAction", completed_view_js)
        ...
        _assert_namespace_export(self, completed_view_js, "mediaPipelineCompletedView", "renderCompletedPendingProof")
        self.assertNotIn("window.renderCompletedPendingProof = renderCompletedPendingProof", completed_view_js)
        ...
        _assert_namespace_export(self, completed_view_js, "mediaPipelineCompletedView", "selectCompletedFinalTrustStep")
        _assert_namespace_export(self, completed_view_js, "mediaPipelineCompletedView", "completedReviewRows")
        self.assertNotIn("window.selectCompletedFinalTrustStep = selectCompletedFinalTrustStep", completed_view_js)
        self.assertNotIn("window.completedReviewRows = completedReviewRows", completed_view_js)
        ...
        _assert_namespace_export(self, completed_view_js, "mediaPipelineCompletedView", "renderCompletedPilotEvidencePacket")
        self.assertNotIn("window.renderCompletedPilotEvidencePacket = renderCompletedPilotEvidencePacket", completed_view_js)
        self.assertIn("completedView.renderCompletedPilotEvidencePacket?.(undefined, undefined, undefined, undefined, commandHistory)", command_history_js)
        self.assertIn("completedView.renderCompletedPilotEvidencePacket(", pending_publish_view_js)
        _assert_namespace_export(self, completed_view_js, "mediaPipelineCompletedView", "renderCompletedRealMediaProof")
        self.assertNotIn("window.renderCompletedRealMediaProof = renderCompletedRealMediaProof", completed_view_js)
        self.assertIn("completedView.renderCompletedRealMediaProof(", pending_publish_view_js)
        ...
        self.assertIn("completedClearFiltersButton.addEventListener(\"click\", () => window.mediaPipelineCompletedView?.resetCompletedFilters?.())", js)
        _assert_namespace_export(self, completed_view_js, "mediaPipelineCompletedView", "resetCompletedFilters")
        self.assertNotIn("window.resetCompletedFilters = resetCompletedFilters", completed_view_js)
        ...
        self.assertIn("completedView.renderCompletedPendingProof(", pending_publish_view_js)
        self.assertIn("completedView.getLastCompletedRows()", pending_publish_view_js)
        self.assertNotIn("window.renderCompletedPendingProof(", pending_publish_view_js)
        self.assertIn("completedView.getLastCompletedRows()", pending_publish_confidence_js)
        self.assertIn("const completedView = window.mediaPipelineCompletedView || {}", pending_publish_details_js)
        self.assertNotIn("window.getLastCompletedRows(", pending_publish_view_js)
        self.assertNotIn("window.getLastCompletedRows(", pending_publish_confidence_js)
        self.assertNotIn("window.getLastCompletedRows(", pending_publish_details_js)
        ...
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "requestTdarrMatrixAudit")
        self.assertNotIn("window.requestTdarrMatrixAudit = requestTdarrMatrixAudit", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "requestTdarrMatrixRunComparison")
        self.assertNotIn("window.requestTdarrMatrixRunComparison = requestTdarrMatrixRunComparison", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "requestTdarrMatrixRerun")
        self.assertNotIn("window.requestTdarrMatrixRerun = requestTdarrMatrixRerun", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "requestTdarrMatrixEvidenceOpen")
        self.assertNotIn(
            "window.requestTdarrMatrixEvidenceOpen = requestTdarrMatrixEvidenceOpen",
            diagnostics_view_js,
        )
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "requestTdarrMatrixConsole")
        ...
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "renderTdarrMatrixBucketCoverage")
        self.assertNotIn("window.renderTdarrMatrixBucketCoverage = renderTdarrMatrixBucketCoverage", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "renderTdarrMatrixAuditFindings")
        self.assertNotIn("window.renderTdarrMatrixAuditFindings = renderTdarrMatrixAuditFindings", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "isDiagnosticsOpenCommand")
        self.assertNotIn("window.isDiagnosticsOpenCommand = isDiagnosticsOpenCommand", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "diagnosticsOpenHistoryLine")
        self.assertNotIn("window.diagnosticsOpenHistoryLine = diagnosticsOpenHistoryLine", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "selectedDiagnosticsTailTarget")
        self.assertNotIn("window.selectedDiagnosticsTailTarget = selectedDiagnosticsTailTarget", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "selectedDiagnosticsTailMaxBytes")
        self.assertNotIn("window.selectedDiagnosticsTailMaxBytes = selectedDiagnosticsTailMaxBytes", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "setDiagnosticsTailStatus")
        ...
        self.assertIn("function diagnosticsLogRowKey", diagnostics_view_js)
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "diagnosticsLogRowKey")
        self.assertNotIn("window.diagnosticsLogRowKey = diagnosticsLogRowKey", diagnostics_view_js)
        ...
        self.assertIn("commandHistoryView.renderCommandDiagnosticsEvidence(selectedCommand)", diagnostics_view_js)
        ...
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "initDiagnosticsViewEvents")
        self.assertNotIn("window.initDiagnosticsViewEvents = initDiagnosticsViewEvents", diagnostics_view_js)
        ...
        _assert_namespace_export(self, diagnostics_view_js, "mediaPipelineDiagnosticsView", "renderDiagnosticsOpenHistory")
        self.assertNotIn("window.renderDiagnosticsOpenHistory = renderDiagnosticsOpenHistory", diagnostics_view_js)
        ...
        self.assertIn("window.mediaPipelineLaunchView?.renderLaunchSettingsIntentChecklist?.(undefined, lastLaunchReadinessPayload)", launch_readiness_view_js)
        ...
        self.assertIn("commandHistoryView.commandHistoryRowKey(entry)", launch_history_view_js)
        self.assertNotIn("typeof commandHistoryRowKey === \"function\"", launch_history_view_js)
        self.assertIn("commandHistoryView.selectCommandEntry(item.entry)", launch_history_view_js)
        self.assertNotIn("typeof selectCommandEntry === \"function\"", launch_history_view_js)
        self.assertIn("commandHistoryView.commandHistoryRefreshTarget(entry)", launch_history_view_js)
        self.assertIn("commandHistoryView.commandHistoryDiagnosticsActions(entry)", launch_history_view_js)
        self.assertIn("commandHistoryView.commandHistorySuggestedAction(entry)", launch_history_view_js)
        ...
        self.assertIn("launchView.launchSettingsIntentRows(request)", launch_history_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "requestPipelineControl")
        self.assertNotIn("window.requestPipelineControl =", launch_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "isPipelineControlCommand")
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "pipelineControlHistoryLine")
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "renderPipelineControlHistory")
        self.assertNotIn("window.isPipelineControlCommand =", launch_view_js)
        self.assertNotIn("window.pipelineControlHistoryLine =", launch_view_js)
        self.assertNotIn("window.renderPipelineControlHistory =", launch_view_js)
        ...
        self.assertIn("const isLaunchCommand = launchHistoryView.isLaunchCommand || function () { return false; }", launch_view_js)
        self.assertIn("const renderLaunchCommandHistory = launchHistoryView.renderLaunchCommandHistory || function () {}", launch_view_js)
        self.assertNotIn("window.isLaunchCommand =", launch_view_js)
        self.assertNotIn("window.renderLaunchCommandHistory =", launch_view_js)
        self.assertNotIn("window.launchHistoryLine =", launch_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "startPipelineFromForm")
        self.assertNotIn("window.startPipelineFromForm =", launch_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "launchSettingsIntentRows")
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "launchSettingsIntentStatus")
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "renderLaunchSettingsIntentChecklist")
        ...
        self.assertNotIn("window.launchSettingsIntentRows =", launch_view_js)
        self.assertNotIn("window.launchSettingsIntentStatus =", launch_view_js)
        self.assertNotIn("window.renderLaunchSettingsIntentChecklist =", launch_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "launchStartDecisionRows")
        ...
        self.assertNotIn("window.launchStartDecisionRows =", launch_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "launchWorksheetEvidence")
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "launchQueueIntentCategoryMatch")
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "launchPolicyAlignmentQueueIntentEvidence")
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "launchSampleValidationRecordEvidence")
        ...
        self.assertNotIn("window.launchWorksheetEvidence =", launch_view_js)
        self.assertNotIn("window.launchQueueIntentCategoryMatch =", launch_view_js)
        self.assertNotIn("window.launchPolicyAlignmentQueueIntentEvidence =", launch_view_js)
        ...
        self.assertNotIn("window.launchSampleValidationRecordEvidence =", launch_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "launchSampleExecutionRows")
        ...
        self.assertNotIn("window.launchSampleExecutionRows =", launch_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "launchPilotRunReadinessRows")
        ...
        self.assertNotIn("window.launchPilotRunReadinessRows =", launch_view_js)
        ...
        self.assertIn("launchView.renderLaunchSettingsIntentChecklist?.()", command_history_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "pipelineLaunchPreflightLines")
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "rerunLaunchPreflightLines")
        self.assertNotIn("window.pipelineLaunchPreflightLines =", launch_view_js)
        self.assertNotIn("window.rerunLaunchPreflightLines =", launch_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "initLaunchViewEvents")
        self.assertNotIn("window.initLaunchViewEvents =", launch_view_js)
        ...
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "collectRerunStartRequest")
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "startStateJournalArchive")
        self.assertNotIn("window.collectRerunStartRequest =", launch_view_js)
        self.assertNotIn("window.startStateJournalArchive =", launch_view_js)
        self.assertIn("function startRerunFromForm", launch_view_js)
        _assert_namespace_export(self, launch_view_js, "mediaPipelineLaunchView", "startRerunFromForm")
        self.assertNotIn("window.startRerunFromForm =", launch_view_js)
        ...
        self.assertIn('launchView.startRerunFromForm?.({ plan_only: true })', js)
        self.assertIn('launchView.startRerunFromForm?.({ dry_run: true })', js)
        self.assertIn('launchView.startRerunFromForm?.({ dry_run: false })', js)
        ...
        self.assertIn("const launchView = window.mediaPipelineLaunchView || {}", js)
        self.assertIn("launchView.initLaunchViewEvents?.();", js)
        self.assertIn("window.mediaPipelineDiagnosticsView?.initDiagnosticsViewEvents?.();", js)
        self.assertNotIn("\n  initDiagnosticsViewEvents();", js)
        ...
        self.assertIn("launchView.startPipelineFromForm?.()", js)
        self.assertNotIn("startAuditFromForm", js)
        self.assertIn("launchView.startRerunFromForm?.", js)
        ...
        self.assertIn("launchView.requestPipelineControl?.(button.dataset.controlAction || \"\")", js)
