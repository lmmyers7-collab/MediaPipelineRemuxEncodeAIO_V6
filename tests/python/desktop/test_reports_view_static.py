...
class ReportsViewStaticTests(unittest.TestCase):
    ...
    def test_reports_audit_controls_are_backend_owned(self) -> None:
        ...
        self.assertIn("function collectReportAuditStartRequest", source)
        self.assertIn("function startReportAuditFromForm", source)
        self.assertIn('apiPost("/api/audit/start", request)', source)
