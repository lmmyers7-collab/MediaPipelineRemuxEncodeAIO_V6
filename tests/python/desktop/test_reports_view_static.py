...
class ReportsViewStaticTests(unittest.TestCase):
    ...
    def test_reports_audit_controls_are_backend_owned(self) -> None:
        ...
        self.assertIn("reportAuditBusyOperations: {},", state_source)
        self.assertIn("reportAuditRefreshWarning: \"\",", state_source)
        self.assertNotIn("reportAuditCommandBusy: \"\",", state_source)
        ...
        self.assertIn("function setReportAuditOperationBusy", audit_commands_source)
        self.assertIn("function reportAuditOperationIsBusy", audit_commands_source)
        self.assertIn("function queueReportsAuditRefresh", audit_commands_source)
        self.assertIn("REPORT_AUDIT_REFRESH_TIMEOUT_MS", audit_commands_source)
        self.assertIn("Full Reports refresh timed out", audit_commands_source)
        self.assertIn("Wait for top-bar refresh activity to finish", audit_commands_source)
