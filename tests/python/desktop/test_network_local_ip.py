...
from mediapipeline.desktop.network import local_ip
...
class LocalIpPolicyTests(unittest.TestCase):
    ...
    def test_get_all_local_ips_filters_loopback_linklocal_and_invalid_values(self) -> None:
        ...
        ), self.assertLogs("mediapipeline.desktop.network.local_ip", level="DEBUG") as logs:
    ...
    def test_get_all_local_ips_logs_hostname_lookup_failure(self) -> None:
        with (
            ...
            self.assertLogs("mediapipeline.desktop.network.local_ip", level="WARNING") as logs,
        ):
