...
FRIENDLY_LABEL_KEYS = {
    "LibraryGoal",
    "WhatForcesAnEncode",
    "IfEncodedOutputIsTooLarge",
    "NVENCTuningBundle",
    "HowEncodeTargetsAreCalculated",
    "ProcessingStrategy",
    "EnforcementMode",
    "OutputSizeCheck",
...
class ConfigContractTests(unittest.TestCase):
    ...
    def test_invalid_config_payload_is_rejected(self) -> None:
        ...
        for key, value in (
            ...
            ("MovieRoute1440pTargetSizeGB", 0),
            ("MovieRoute4KTargetSizeGB", 0),
            ...
            Config.model_validate(
                {
                    ...
                    "Route1440pLowerHeightTolerancePercent": 0,
    ...
    def test_legacy_movie_tv_size_targets_seed_resolution_size_targets(self) -> None:
        ...
        self.assertEqual(config.MovieRoute4KTargetSizeGB, 9)
    ...
    def test_resolution_size_targets_take_precedence_over_legacy_movie_tv_targets(self) -> None:
        ...
        self.assertEqual(config.MovieRoute1080pTargetSizeGB, 7)
        self.assertEqual(config.MovieRoute1440pTargetSizeGB, 10)
        self.assertEqual(config.MovieRoute4KTargetSizeGB, 14)
    ...
    def test_height_tolerance_percent_keys_take_precedence_over_legacy_heights(self) -> None:
        config = Config.model_validate(
            {
                "Route1080pBucketMaxHeight": 1,
                "Route4KBucketMinHeight": 4320,
